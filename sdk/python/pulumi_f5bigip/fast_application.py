...
class FastApplicationArgs:
    def __init__(__self__, *,
                 fast_json: pulumi.Input[builtins.str],
                 template: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a FastApplication resource.
        :param pulumi.Input[builtins.str] fast_json: Path/Filename of Declarative FAST JSON which is a json file used with builtin ```file``` function
        :param pulumi.Input[builtins.str] template: Name of installed FAST template used to create FAST application. This parameter is required when creating new resource.
        """
    ...
    def fast_json(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @fast_json.setter
    def fast_json(self, value: pulumi.Input[builtins.str]):
...
class _FastApplicationState:
    def __init__(__self__, *,
                 ...
                 fast_json: Optional[pulumi.Input[builtins.str]] = None,
                 template: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] application: A FAST application name.
        ...
        :param pulumi.Input[builtins.str] fast_json: Path/Filename of Declarative FAST JSON which is a json file used with builtin ```file``` function
        :param pulumi.Input[builtins.str] template: Name of installed FAST template used to create FAST application. This parameter is required when creating new resource.
        :param pulumi.Input[builtins.str] tenant: A FAST tenant name on which you want to manage application.
        """
    ...
    @property
    @pulumi.getter(name="fastJson")
    def fast_json(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Path/Filename of Declarative FAST JSON which is a json file used with builtin ```file``` function
        """
        return pulumi.get(self, "fast_json")
    ...
    @fast_json.setter
    def fast_json(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "fast_json", value)
...
class FastApplication(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            fast_json: Optional[pulumi.Input[builtins.str]] = None,
            template: Optional[pulumi.Input[builtins.str]] = None,
            tenant: Optional[pulumi.Input[builtins.str]] = None) -> 'FastApplication':
        """
    ...
    @property
    @pulumi.getter(name="fastJson")
    def fast_json(self) -> pulumi.Output[builtins.str]:
        """
        Path/Filename of Declarative FAST JSON which is a json file used with builtin ```file``` function
        """
        return pulumi.get(self, "fast_json")
