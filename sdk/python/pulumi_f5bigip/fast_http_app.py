...
class FastHttpAppArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] endpoint_ltm_policies: List of LTM Policies to be applied FAST HTTP Application.
        ...
        :param pulumi.Input[builtins.str] existing_pool: Select an existing BIG-IP Pool
...
class _FastHttpAppState:
    def __init__(__self__, *,
                 ...
                 existing_waf_security_policy: Optional[pulumi.Input[builtins.str]] = None,
                 fallback_persistence: Optional[pulumi.Input[builtins.str]] = None,
                 fast_http_json: Optional[pulumi.Input[builtins.str]] = None,
                 load_balancing_mode: Optional[pulumi.Input[builtins.str]] = None,
                 monitor: Optional[pulumi.Input['FastHttpAppMonitorArgs']] = None,
                 persistence_profile: Optional[pulumi.Input[builtins.str]] = None,
                 persistence_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] existing_waf_security_policy: Name of an existing WAF Security policy.
        :param pulumi.Input[builtins.str] fallback_persistence: Type of fallback persistence record to be created for each new client connection.
        :param pulumi.Input[builtins.str] fast_http_json: Json payload for FAST HTTP application.
        :param pulumi.Input[builtins.str] load_balancing_mode: A `load balancing method` is an algorithm that the BIG-IP system uses to select a pool member for processing a request. F5 recommends the Least Connections load balancing method
        :param pulumi.Input['FastHttpAppMonitorArgs'] monitor: `monitor` block takes input for FAST-Generated Pool Monitor.
               See Pool Monitor below for more details.
        :param pulumi.Input[builtins.str] persistence_profile: Name of an existing BIG-IP persistence profile to be used.
    ...
    def fast_http_json(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def fast_http_json(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FastHttpApp(pulumi.CustomResource):
    ...
    pulumi_type = "f5bigip:index/fastHttpApp:FastHttpApp"
    ...
    @property
    @pulumi.getter(name="fastHttpJson")
    def fast_http_json(self) -> pulumi.Output[builtins.str]:
        """
        Json payload for FAST HTTP application.
        """
        return pulumi.get(self, "fast_http_json")
