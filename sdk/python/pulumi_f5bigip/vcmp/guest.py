...
class GuestArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] initial_hotfix: Specifies the hotfix ISO image file which is applied on top of the base image.
        :param pulumi.Input[_builtins.str] initial_image: Specifies the base software release ISO image file for installing the TMOS hypervisor instance.
        :param pulumi.Input[_builtins.str] mgmt_address: Specifies the IP address and subnet or subnet mask you use to access the guest when you want to manage a module running within the guest.
        :param pulumi.Input[_builtins.str] mgmt_network: Specifies the method by which the management address is used in the vCMP guest. options : [`bridged`,`isolated`,`host-only`].
        :param pulumi.Input[_builtins.str] mgmt_route: Specifies the gateway address for the `mgmt_address`. Can be set to `none` to remove the value from the configuration.
        :param pulumi.Input[_builtins.int] min_number_of_slots: Specifies the minimum number of slots the guest must be assigned to in order to deploy.
        :param pulumi.Input[_builtins.int] number_of_slots: Specifies the number of slots for the system to use when creating the guest.
        :param pulumi.Input[_builtins.str] state: Specifies the state of the vCMP guest on the system. options : [`configured`,`provisioned`,`deployed`].
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] vlans: Specifies the list of VLANs the vCMP guest uses to communicate with other guests, the host, and with the external network. The naming format must be the combination of the partition + name. For example /Common/my-vlan
        """
...
class _GuestState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] cores_per_slot: Specifies the number of cores the system allocates to the guest.
        :param pulumi.Input[_builtins.bool] delete_virtual_disk: Indicates if virtual disk associated with vCMP guest should be removed during remove operation.  The default is `true`
        :param pulumi.Input[_builtins.str] full_path: Resource name including prepended partition path.
        :param pulumi.Input[_builtins.str] initial_hotfix: Specifies the hotfix ISO image file which is applied on top of the base image.
        :param pulumi.Input[_builtins.str] initial_image: Specifies the base software release ISO image file for installing the TMOS hypervisor instance.
        :param pulumi.Input[_builtins.str] mgmt_address: Specifies the IP address and subnet or subnet mask you use to access the guest when you want to manage a module running within the guest.
        :param pulumi.Input[_builtins.str] mgmt_network: Specifies the method by which the management address is used in the vCMP guest. options : [`bridged`,`isolated`,`host-only`].
        ...
        :param pulumi.Input[_builtins.int] number_of_slots: Specifies the number of slots for the system to use when creating the guest.
        :param pulumi.Input[_builtins.str] state: Specifies the state of the vCMP guest on the system. options : [`configured`,`provisioned`,`deployed`].
        :param pulumi.Input[_builtins.str] virtual_disk: Virtual disk associated with vCMP guest.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] vlans: Specifies the list of VLANs the vCMP guest uses to communicate with other guests, the host, and with the external network. The naming format must be the combination of the partition + name. For example /Common/my-vlan
        """
        if allowed_slots is not None:
            pulumi.set(__self__, "allowed_slots", allowed_slots)
...
class Guest(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="allowedSlots")
    def allowed_slots(self) -> pulumi.Output[Sequence[_builtins.int]]:
        """
        Contains those slots to which the guest is allowed to be assigned.
        """
        return pulumi.get(self, "allowed_slots")
    ...
    @_builtins.property
    @pulumi.getter(name="coresPerSlot")
    def cores_per_slot(self) -> pulumi.Output[_builtins.int]:
        """
        Specifies the number of cores the system allocates to the guest.
        """
        return pulumi.get(self, "cores_per_slot")
    ...
    @_builtins.property
    @pulumi.getter(name="deleteVirtualDisk")
    def delete_virtual_disk(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Indicates if virtual disk associated with vCMP guest should be removed during remove operation.  The default is `true`
        """
        return pulumi.get(self, "delete_virtual_disk")
    ...
    @_builtins.property
    @pulumi.getter(name="initialHotfix")
    def initial_hotfix(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies the hotfix ISO image file which is applied on top of the base image.
        """
        return pulumi.get(self, "initial_hotfix")
    ...
    @_builtins.property
    @pulumi.getter(name="initialImage")
    def initial_image(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies the base software release ISO image file for installing the TMOS hypervisor instance.
        """
        return pulumi.get(self, "initial_image")
    ...
    @_builtins.property
    @pulumi.getter(name="mgmtAddress")
    def mgmt_address(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies the IP address and subnet or subnet mask you use to access the guest when you want to manage a module running within the guest.
        """
        return pulumi.get(self, "mgmt_address")
    ...
    @_builtins.property
    @pulumi.getter(name="mgmtNetwork")
    def mgmt_network(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies the method by which the management address is used in the vCMP guest. options : [`bridged`,`isolated`,`host-only`].
        """
        return pulumi.get(self, "mgmt_network")
    ...
    @_builtins.property
    @pulumi.getter(name="mgmtRoute")
    def mgmt_route(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies the gateway address for the `mgmt_address`. Can be set to `none` to remove the value from the configuration.
        """
        return pulumi.get(self, "mgmt_route")
    ...
    @_builtins.property
    @pulumi.getter(name="minNumberOfSlots")
    def min_number_of_slots(self) -> pulumi.Output[_builtins.int]:
        """
        Specifies the minimum number of slots the guest must be assigned to in order to deploy.
        """
        return pulumi.get(self, "min_number_of_slots")
    ...
    @_builtins.property
    @pulumi.getter(name="numberOfSlots")
    def number_of_slots(self) -> pulumi.Output[_builtins.int]:
        """
        Specifies the number of slots for the system to use when creating the guest.
        """
        return pulumi.get(self, "number_of_slots")
    ...
    @_builtins.property
    @pulumi.getter(name="virtualDisk")
    def virtual_disk(self) -> pulumi.Output[_builtins.str]:
        """
        Virtual disk associated with vCMP guest.
        """
        return pulumi.get(self, "virtual_disk")
    ...
    @_builtins.property
    @pulumi.getter
    def vlans(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Specifies the list of VLANs the vCMP guest uses to communicate with other guests, the host, and with the external network. The naming format must be the combination of the partition + name. For example /Common/my-vlan
        """
        return pulumi.get(self, "vlans")
