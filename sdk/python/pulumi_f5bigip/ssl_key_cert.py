...
class SslKeyCertArgs:
    def __init__(__self__, *,
                 cert_content: pulumi.Input[builtins.str],
                 cert_name: pulumi.Input[builtins.str],
                 key_content: pulumi.Input[builtins.str],
                 key_name: pulumi.Input[builtins.str],
                 cert_full_path: Optional[pulumi.Input[builtins.str]] = None,
                 cert_monitoring_type: Optional[pulumi.Input[builtins.str]] = None,
                 cert_ocsp: Optional[pulumi.Input[builtins.str]] = None,
                 issuer_cert: Optional[pulumi.Input[builtins.str]] = None,
                 key_full_path: Optional[pulumi.Input[builtins.str]] = None,
                 partition: Optional[pulumi.Input[builtins.str]] = None,
                 passphrase: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a SslKeyCert resource.
        :param pulumi.Input[builtins.str] cert_content: The content of the cert.
        :param pulumi.Input[builtins.str] cert_name: Name of the SSL certificate to be Imported on to BIGIP.
        :param pulumi.Input[builtins.str] key_content: The content of the key.
        :param pulumi.Input[builtins.str] key_name: Name of the SSL key to be Imported on to BIGIP.
        :param pulumi.Input[builtins.str] cert_full_path: full path of the SSL certificate on the BIGIP.
        :param pulumi.Input[builtins.str] cert_monitoring_type: Specifies the type of monitoring used.
        :param pulumi.Input[builtins.str] cert_ocsp: Specifies the OCSP responder.
        :param pulumi.Input[builtins.str] issuer_cert: Specifies the issuer certificate.
        :param pulumi.Input[builtins.str] key_full_path: full path of the SSL key on the BIGIP.
        :param pulumi.Input[builtins.str] partition: Partition on to SSL certificate and key to be imported.
        :param pulumi.Input[builtins.str] passphrase: Passphrase on the SSL key.
        """
    ...
    def cert_content(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @cert_content.setter
    def cert_content(self, value: pulumi.Input[builtins.str]):
    ...
    def key_content(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @key_content.setter
    def key_content(self, value: pulumi.Input[builtins.str]):
    ...
    def cert_full_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cert_full_path(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cert_full_path", value)

    @property
    @pulumi.getter(name="certMonitoringType")
    def cert_monitoring_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cert_monitoring_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cert_monitoring_type", value)

    @property
    @pulumi.getter(name="certOcsp")
    def cert_ocsp(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @cert_ocsp.setter
    def cert_ocsp(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def key_full_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def key_full_path(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SslKeyCertState:
    def __init__(__self__, *,
                 cert_content: Optional[pulumi.Input[builtins.str]] = None,
                 cert_full_path: Optional[pulumi.Input[builtins.str]] = None,
                 cert_monitoring_type: Optional[pulumi.Input[builtins.str]] = None,
                 cert_name: Optional[pulumi.Input[builtins.str]] = None,
                 cert_ocsp: Optional[pulumi.Input[builtins.str]] = None,
                 issuer_cert: Optional[pulumi.Input[builtins.str]] = None,
                 key_content: Optional[pulumi.Input[builtins.str]] = None,
                 key_full_path: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="certContent")
    def cert_content(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The content of the cert.
        """
        return pulumi.get(self, "cert_content")
    ...
    @cert_content.setter
    def cert_content(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cert_content", value)
    ...
    @property
    @pulumi.getter(name="keyContent")
    def key_content(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The content of the key.
        """
        return pulumi.get(self, "key_content")
    ...
    @key_content.setter
    def key_content(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "key_content", value)
...
class SslKeyCert(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            key_name: Optional[pulumi.Input[builtins.str]] = None,
            partition: Optional[pulumi.Input[builtins.str]] = None,
            passphrase: Optional[pulumi.Input[builtins.str]] = None) -> 'SslKeyCert':
        """
    ...
    @property
    @pulumi.getter(name="certContent")
    def cert_content(self) -> pulumi.Output[builtins.str]:
        """
        The content of the cert.
        """
        return pulumi.get(self, "cert_content")
    ...
    @property
    @pulumi.getter(name="certFullPath")
    def cert_full_path(self) -> pulumi.Output[builtins.str]:
        """
        full path of the SSL certificate on the BIGIP.
        """
        return pulumi.get(self, "cert_full_path")
    ...
    @property
    @pulumi.getter(name="certMonitoringType")
    def cert_monitoring_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the type of monitoring used.
        """
        return pulumi.get(self, "cert_monitoring_type")
    ...
    @property
    @pulumi.getter(name="certOcsp")
    def cert_ocsp(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the OCSP responder.
        """
        return pulumi.get(self, "cert_ocsp")
    ...
    @property
    @pulumi.getter(name="keyContent")
    def key_content(self) -> pulumi.Output[builtins.str]:
        """
        The content of the key.
        """
        return pulumi.get(self, "key_content")
    ...
    @property
    @pulumi.getter(name="keyFullPath")
    def key_full_path(self) -> pulumi.Output[builtins.str]:
        """
        full path of the SSL key on the BIGIP.
        """
        return pulumi.get(self, "key_full_path")
