...
class BigIqAs3Args:
    def __init__(__self__, *,
                 as3_json: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] bigiq_address: Address of the BIG-IQ to which your targer BIG-IP is attached
        :param pulumi.Input[builtins.str] bigiq_password: Password of the BIG-IQ to which your targer BIG-IP is attached
        :param pulumi.Input[builtins.str] bigiq_user: User name  of the BIG-IQ to which your targer BIG-IP is attached
        ...
        :param pulumi.Input[builtins.bool] ignore_metadata: Set True if you want to ignore metadata changes during update. By default it is set to `true`
        ...
        :param pulumi.Input[builtins.str] tenant_list: Name of Tenant
        """
    ...
    def as3_json(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @as3_json.setter
    def as3_json(self, value: pulumi.Input[builtins.str]):
...
class BigIqAs3(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            bigiq_user: Optional[pulumi.Input[builtins.str]] = None,
            ignore_metadata: Optional[pulumi.Input[builtins.bool]] = None,
            tenant_list: Optional[pulumi.Input[builtins.str]] = None) -> 'BigIqAs3':
        """
    ...
    @property
    @pulumi.getter(name="as3Json")
    def as3_json(self) -> pulumi.Output[builtins.str]:
        """
        Path/Filename of Declarative AS3 JSON which is a json file used with builtin ```file``` function
        """
        return pulumi.get(self, "as3_json")
