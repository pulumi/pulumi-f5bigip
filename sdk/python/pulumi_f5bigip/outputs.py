...
class EventServiceDiscoveryNode(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: name of node
        :param builtins.str ip: ip of nonde
...
class FastHttpAppMonitor(dict):
    ...
    def __init__(__self__, *,
                 ...
                 monitor_auth: Optional[builtins.bool] = None,
                 password: Optional[builtins.str] = None,
                 response: Optional[builtins.str] = None,
                 send_string: Optional[builtins.str] = None,
                 username: Optional[builtins.str] = None):
        """
        :param builtins.int interval: Set the time between health checks,in seconds for FAST-Generated Pool Monitor.
        :param builtins.bool monitor_auth: set `true` if the servers require login credentials for web access on FAST-Generated Pool Monitor. default is `false`.
        :param builtins.str password: password for web access on FAST-Generated Pool Monitor.
        :param builtins.str response: The presence of this string anywhere in the HTTP response implies availability.
        :param builtins.str send_string: Specify data to be sent during each health check for FAST-Generated Pool Monitor.
        :param builtins.str username: username for web access on FAST-Generated Pool Monitor.
        """
    ...
    def monitor_auth(self) -> Optional[builtins.bool]:
        """
    ...
    def send_string(self) -> Optional[builtins.str]:
        """
...
class FastHttpAppPoolMember(dict):
    ...
    def __init__(__self__, *,
                 ...
                 connection_limit: Optional[builtins.int] = None,
                 port: Optional[builtins.int] = None,
                 priority_group: Optional[builtins.int] = None,
                 share_nodes: Optional[builtins.bool] = None):
        """
        :param Sequence[builtins.str] addresses: List of server address to be used for FAST-Generated Pool.
        :param builtins.int connection_limit: connectionLimit value to be used for FAST-Generated Pool.
        :param builtins.int port: port number of serviceport to be used for FAST-Generated Pool.
        :param builtins.int priority_group: priorityGroup value to be used for FAST-Generated Pool.
        :param builtins.bool share_nodes: shareNodes value to be used for FAST-Generated Pool.
        """
    ...
    def connection_limit(self) -> Optional[builtins.int]:
        """
    ...
    def priority_group(self) -> Optional[builtins.int]:
        """
    ...
    def share_nodes(self) -> Optional[builtins.bool]:
        """
...
class FastHttpAppVirtualServer(dict):
    def __init__(__self__, *,
                 ...
                 port: builtins.int):
        """
        :param builtins.str ip: IP4/IPv6 address to be used for virtual server ex: `10.1.1.1`
        :param builtins.int port: Port number to used for accessing virtual server/application
        """
        pulumi.set(__self__, "ip", ip)
        pulumi.set(__self__, "port", port)
...
class FastHttpAppWafSecurityPolicy(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enable: Setting `true` will enable FAST to create WAF Security Policy.
        """
...
class FastHttpsAppTlsClientProfile(dict):
    ...
    def __init__(__self__, *,
                 tls_cert_name: builtins.str,
                 tls_key_name: builtins.str):
        """
        :param builtins.str tls_cert_name: Name of existing BIG-IP SSL certificate to be used for FAST-Generated TLS Server Profile.
        :param builtins.str tls_key_name: Name of existing BIG-IP SSL Key to be used for FAST-Generated TLS Server Profile.
        """
    ...
    def tls_cert_name(self) -> builtins.str:
        """
    ...
    def tls_key_name(self) -> builtins.str:
        """
...
class FastUdpAppMonitor(dict):
    ...
    def __init__(__self__, *,
                 ...
                 send_string: Optional[builtins.str] = None):
        """
        :param builtins.str expected_response: The presence of this optional string is required in the response, if specified it confirms availability.
        :param builtins.int interval: Set the time between health checks,in seconds for FAST-Generated Pool Monitor.
        :param builtins.str send_string: Optional data to be sent during each health check.
        """
...
class SaasBotDefenseProfileProtectedEndpoint(dict):
    ...
    def __init__(__self__, *,
                 ...
                 mitigation_action: Optional[builtins.str] = None,
                 post: Optional[builtins.str] = None,
                 put: Optional[builtins.str] = None):
        """
        :param builtins.str name: Unique name for the protected endpoint
        :param builtins.str endpoint: Specifies the path to the web page to be protected by BD. For example, `/login`.
        :param builtins.str host: hostname or IP address of the web page to be protected by the Bot Defense
        :param builtins.str mitigation_action: Specifies whether the BIG-IP or F5 XC Bot Defense handles mitigation of malicious HTTP requests. This field is enabled only if the Service Level field is set to Advanced/Premium
        :param builtins.str post: POST field to protect the path when it has a POST method, `enabled` or `disabled`
        :param builtins.str put: PUT field to protect the path when it has a PUT method,`enabled` or `disabled`
        """
    ...
    def mitigation_action(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def post(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def put(self) -> Optional[builtins.str]:
        """
...
class WafPolicyFileType(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool allowed: Determines whether the file type is allowed or disallowed. In either of these cases the VIOL_FILETYPE violation is issued (if enabled) for an incoming request- 
               * No allowed file type matched the file type of the request.
               * The file type of the request matched a disallowed file type.
        :param builtins.str name: Specifies the file type name as appearing in the URL extension.
        :param builtins.str type: Determines the type of the name attribute. Only when setting the type to `wildcard` will the special wildcard characters in the name be interpreted as such
        """
...
class WafPolicyGraphqlProfile(dict):
    ...
    def __init__(__self__, *,
                 name: builtins.str,
                 attack_signatures_check: Optional[builtins.bool] = None,
                 defense_attributes: Optional[Sequence['outputs.WafPolicyGraphqlProfileDefenseAttribute']] = None,
                 metachar_elementcheck: Optional[builtins.bool] = None):
        """
        :param builtins.str name: The unique user-given name of the policy. Policy names cannot contain spaces or special characters. Allowed characters are a-z, A-Z, 0-9, dot, dash (-), colon (:) and underscore (_).
        :param builtins.bool attack_signatures_check: Specifies when checked (enabled) that you want attack signatures and threat campaigns to be detected on this GraphQL profile and possibly override the security policy settings of an attack signature or threat campaign specifically for this GraphQL profile. After you enable this setting, the system displays a list of attack signatures and and threat campaigns. The default is enabled
        :param Sequence['WafPolicyGraphqlProfileDefenseAttributeArgs'] defense_attributes: defense_attributes settings for policy
        :param builtins.bool metachar_elementcheck: Specifies when checked (enabled) that the system enforces the security policy settings of a meta character for the GraphQL profile. After you enable this setting, the system displays a list of meta characters. The default is enabled
        """
        pulumi.set(__self__, "name", name)
    ...
    def attack_signatures_check(self) -> Optional[builtins.bool]:
        """
    ...
    def metachar_elementcheck(self) -> Optional[builtins.bool]:
        """
...
class WafPolicyGraphqlProfileDefenseAttribute(dict):
    ...
    def __init__(__self__, *,
                 allow_introspection_queries: Optional[builtins.bool] = None,
                 maximum_batched_queries: Optional[builtins.str] = None,
                 maximum_structure_depth: Optional[builtins.str] = None,
                 maximum_total_length: Optional[builtins.str] = None,
                 maximum_value_length: Optional[builtins.str] = None,
                 tolerate_parsing_warnings: Optional[builtins.bool] = None):
        """
        :param builtins.bool allow_introspection_queries: Introspection queries can also be enforced to prevent attackers from using them to
               understand the API structure and potentially breach an application.
        :param builtins.str maximum_batched_queries: Specifies the highest number of batched queries allowed by the security policy.
        :param builtins.str maximum_structure_depth: Specifies the greatest nesting depth found in the GraphQL structure allowed by the security policy.
        :param builtins.str maximum_total_length: Specifies the longest length, in bytes, allowed by the security policy of the request payload, or parameter value, where the GraphQL data was found.
        :param builtins.str maximum_value_length: Specifies the longest length (in bytes) of the longest GraphQL element value in the document allowed by the security policy.
        :param builtins.bool tolerate_parsing_warnings: Specifies, when checked (enabled), that the system does not report when the security enforcer encounters warnings while parsing GraphQL content. Specifies when cleared (disabled), that the security policy reports when the security enforcer encounters warnings while parsing GraphQL content. The default setting is disabled.
        """
    ...
    def allow_introspection_queries(self) -> Optional[builtins.bool]:
        """
    ...
    def maximum_batched_queries(self) -> Optional[builtins.str]:
        """
    ...
    def maximum_structure_depth(self) -> Optional[builtins.str]:
        """
    ...
    def maximum_total_length(self) -> Optional[builtins.str]:
        """
    ...
    def maximum_value_length(self) -> Optional[builtins.str]:
        """
    ...
    def tolerate_parsing_warnings(self) -> Optional[builtins.bool]:
        """
        Specifies, when checked (enabled), that the system does not report when the security enforcer encounters warnings while parsing GraphQL content. Specifies when cleared (disabled), that the security policy reports when the security enforcer encounters warnings while parsing GraphQL content. The default setting is disabled.
        """
...
class WafPolicyIpException(dict):
    ...
    def __init__(__self__, *,
                 ...
                 block_requests: Optional[builtins.str] = None,
                 description: Optional[builtins.str] = None,
                 ignore_anomalies: Optional[builtins.bool] = None,
                 ignore_ipreputation: Optional[builtins.bool] = None,
                 trustedby_policybuilder: Optional[builtins.bool] = None):
        """
        :param builtins.str ip_address: Specifies the IP address that you want the system to trust.
        :param builtins.str ip_mask: Specifies the netmask of the exceptional IP address. This is an optional field.
        :param builtins.str block_requests: Specifies how the system responds to blocking requests sent from this IP address. Possible options [`always`, `never`, `policy-default`].
        :param builtins.str description: Specifies the description of the policy.
        :param builtins.bool ignore_anomalies: Specifies when enabled that the system considers this IP address legitimate and does not take it into account when performing brute force prevention.
        :param builtins.bool ignore_ipreputation: Specifies when enabled that the system considers this IP address legitimate even if it is found in the IP Intelligence database (a database of questionable IP addresses).
        :param builtins.bool trustedby_policybuilder: Specifies when enabled the Policy Builder considers traffic from this IP address as being safe.
        """
    ...
    def block_requests(self) -> Optional[builtins.str]:
        """
    ...
    def ignore_anomalies(self) -> Optional[builtins.bool]:
        """
    ...
    def ignore_ipreputation(self) -> Optional[builtins.bool]:
        """
    ...
    def trustedby_policybuilder(self) -> Optional[builtins.bool]:
        """
...
class WafPolicyPolicyBuilder(dict):
    ...
    def __init__(__self__, *,
                 learning_mode: Optional[builtins.str] = None):
        """
        :param builtins.str learning_mode: learning mode setting for policy-builder, possible options: [`automatic`,`disabled`, `manual`]
        """
    ...
    def learning_mode(self) -> Optional[builtins.str]:
        """
...
class WafPolicySignaturesSetting(dict):
    ...
    def __init__(__self__, *,
                 placesignatures_in_staging: Optional[builtins.bool] = None,
                 signature_staging: Optional[builtins.bool] = None):
        """
        :param builtins.bool signature_staging: setting true will enforce all signature from staging
        """
    ...
    def placesignatures_in_staging(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "placesignatures_in_staging")

    @property
    @pulumi.getter(name="signatureStaging")
    def signature_staging(self) -> Optional[builtins.bool]:
        """
