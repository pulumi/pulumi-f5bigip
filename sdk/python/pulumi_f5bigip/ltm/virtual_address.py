...
class VirtualAddressArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Name of the virtual address
        :param pulumi.Input[_builtins.str] advertize_route: Enabled dynamic routing of the address ( In versions prior to BIG-IP 13.0.0 HF1, you can configure the Route Advertisement option for a virtual address to be either Enabled or Disabled only. Beginning with BIG-IP 13.0.0 HF1, F5 added more settings for the Route Advertisement option. In addition, the Enabled setting is deprecated and replaced by the Selective setting. For more information, please look into KB article https://support.f5.com/csp/article/K85543242 )
        :param pulumi.Input[_builtins.bool] arp: Enable or disable ARP for the virtual address
        :param pulumi.Input[_builtins.bool] auto_delete: Automatically delete the virtual address with the virtual server
        :param pulumi.Input[_builtins.int] conn_limit: Max number of connections for virtual address
        :param pulumi.Input[_builtins.bool] enabled: Enable or disable the virtual address
        :param pulumi.Input[_builtins.str] icmp_echo: Specifies how the system sends responses to ICMP echo requests on a per-virtual address basis.
        :param pulumi.Input[_builtins.str] traffic_group: Specify the partition and traffic group
        """
...
class VirtualAddress(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="advertizeRoute")
    def advertize_route(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Enabled dynamic routing of the address ( In versions prior to BIG-IP 13.0.0 HF1, you can configure the Route Advertisement option for a virtual address to be either Enabled or Disabled only. Beginning with BIG-IP 13.0.0 HF1, F5 added more settings for the Route Advertisement option. In addition, the Enabled setting is deprecated and replaced by the Selective setting. For more information, please look into KB article https://support.f5.com/csp/article/K85543242 )
        """
        return pulumi.get(self, "advertize_route")
    ...
    @_builtins.property
    @pulumi.getter(name="autoDelete")
    def auto_delete(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Automatically delete the virtual address with the virtual server
        """
        return pulumi.get(self, "auto_delete")
    ...
    @_builtins.property
    @pulumi.getter(name="connLimit")
    def conn_limit(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Max number of connections for virtual address
        """
        return pulumi.get(self, "conn_limit")
    ...
    @_builtins.property
    @pulumi.getter(name="icmpEcho")
    def icmp_echo(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies how the system sends responses to ICMP echo requests on a per-virtual address basis.
        """
        return pulumi.get(self, "icmp_echo")
