...
class RequestLogProfileArgs:
    def __init__(__self__, *,
                 ...
                 proxy_response: Optional[pulumi.Input[builtins.str]] = None,
                 proxyclose_on_error: Optional[pulumi.Input[builtins.str]] = None,
                 proxyrespond_on_loggingerror: Optional[pulumi.Input[builtins.str]] = None,
                 request_logging: Optional[pulumi.Input[builtins.str]] = None,
                 requestlog_error_pool: Optional[pulumi.Input[builtins.str]] = None,
                 requestlog_error_protocol: Optional[pulumi.Input[builtins.str]] = None,
                 requestlog_error_template: Optional[pulumi.Input[builtins.str]] = None,
                 requestlog_pool: Optional[pulumi.Input[builtins.str]] = None,
                 requestlog_protocol: Optional[pulumi.Input[builtins.str]] = None,
                 requestlog_template: Optional[pulumi.Input[builtins.str]] = None,
                 response_logging: Optional[pulumi.Input[builtins.str]] = None,
                 responselog_error_pool: Optional[pulumi.Input[builtins.str]] = None,
                 responselog_error_protocol: Optional[pulumi.Input[builtins.str]] = None,
                 responselog_error_template: Optional[pulumi.Input[builtins.str]] = None,
                 responselog_pool: Optional[pulumi.Input[builtins.str]] = None,
                 responselog_protocol: Optional[pulumi.Input[builtins.str]] = None,
                 responselog_template: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a RequestLogProfile resource.
        :param pulumi.Input[builtins.str] name: Name of the Request Logging profile,name of Profile should be full path. Full path is the combination of the `partition + profile name`,For example `/Common/request-log-profile-tc1`.
        :param pulumi.Input[builtins.str] defaults_from: Specifies the profile from which this profile inherits settings. The default is the system-supplied `request-log` profile.
        :param pulumi.Input[builtins.str] description: Specifies user-defined description.
        :param pulumi.Input[builtins.str] proxy_response: Defines the pool associated with logging request errors. The default is None.
        :param pulumi.Input[builtins.str] proxyclose_on_error: Defines the pool associated with logging request errors. The default is None.
        :param pulumi.Input[builtins.str] proxyrespond_on_loggingerror: Defines the pool associated with logging request errors. The default is None.
        :param pulumi.Input[builtins.str] request_logging: Enables or disables request logging. The default is `disabled`, possible values are `enabled` and `disabled`.
        :param pulumi.Input[builtins.str] requestlog_error_pool: Defines the pool associated with logging request errors. The default is None.
        :param pulumi.Input[builtins.str] requestlog_error_protocol: Specifies the protocol to be used for high-speed logging of request errors. The default is `mds-udp`,possible values are `mds-udp` and `mds-tcp`.
        :param pulumi.Input[builtins.str] requestlog_error_template: Specifies the directives and entries to be logged for request errors.
        :param pulumi.Input[builtins.str] requestlog_pool: Defines the pool to send logs to. Typically, the pool will contain one or more syslog servers. It is recommended that you create a pool specifically for logging requests. The default is `none`.
        :param pulumi.Input[builtins.str] requestlog_protocol: Specifies the protocol to be used for high-speed logging of requests. The default is `mds-udp`,possible values are `mds-udp` and `mds-tcp`.
        :param pulumi.Input[builtins.str] requestlog_template: Specifies the directives and entries to be logged. More infor on requestlog_template can be found [here](https://techdocs.f5.com/en-us/bigip-15-0-0/external-monitoring-of-big-ip-systems-implementations/configuring-request-logging.html). how to use can be find [here](https://my.f5.com/manage/s/article/K00847516).
        :param pulumi.Input[builtins.str] response_logging: Enables or disables response logging. The default is `disabled`, possible values are `enabled` and `disabled`.
        :param pulumi.Input[builtins.str] responselog_error_pool: Defines the pool associated with logging response errors. The default is `none`.
        :param pulumi.Input[builtins.str] responselog_error_protocol: Specifies the protocol to be used for high-speed logging of response errors. The default is `mds-udp`,possible values are `mds-udp` and `mds-tcp`.
        :param pulumi.Input[builtins.str] responselog_error_template: Specifies the directives and entries to be logged for request errors.
        :param pulumi.Input[builtins.str] responselog_pool: Defines the pool to send logs to. Typically, the pool contains one or more syslog servers. It is recommended that you create a pool specifically for logging responses. The default is `none`.
        :param pulumi.Input[builtins.str] responselog_protocol: Specifies the protocol to be used for high-speed logging of responses. The default is `mds-udp`,possible values are `mds-udp` and `mds-tcp`.
        :param pulumi.Input[builtins.str] responselog_template: Specifies the directives and entries to be logged. More infor on responselog_template can be found [here](https://techdocs.f5.com/en-us/bigip-15-0-0/external-monitoring-of-big-ip-systems-implementations/configuring-request-logging.html). how to use can be find [here](https://my.f5.com/manage/s/article/K00847516).
        """
    ...
    def proxy_response(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def proxy_response(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "proxy_response", value)

    @property
    @pulumi.getter(name="proxycloseOnError")
    def proxyclose_on_error(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Defines the pool associated with logging request errors. The default is None.
        """
    ...
    def proxyclose_on_error(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "proxyclose_on_error", value)

    @property
    @pulumi.getter(name="proxyrespondOnLoggingerror")
    def proxyrespond_on_loggingerror(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Defines the pool associated with logging request errors. The default is None.
        """
    ...
    def proxyrespond_on_loggingerror(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "proxyrespond_on_loggingerror", value)

    @property
    @pulumi.getter(name="requestLogging")
    def request_logging(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def request_logging(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "request_logging", value)

    @property
    @pulumi.getter(name="requestlogErrorPool")
    def requestlog_error_pool(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Defines the pool associated with logging request errors. The default is None.
        """
    ...
    def requestlog_error_pool(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "requestlog_error_pool", value)

    @property
    @pulumi.getter(name="requestlogErrorProtocol")
    def requestlog_error_protocol(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def requestlog_error_protocol(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "requestlog_error_protocol", value)

    @property
    @pulumi.getter(name="requestlogErrorTemplate")
    def requestlog_error_template(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def requestlog_error_template(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "requestlog_error_template", value)

    @property
    @pulumi.getter(name="requestlogPool")
    def requestlog_pool(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def requestlog_pool(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "requestlog_pool", value)

    @property
    @pulumi.getter(name="requestlogProtocol")
    def requestlog_protocol(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def requestlog_protocol(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "requestlog_protocol", value)

    @property
    @pulumi.getter(name="requestlogTemplate")
    def requestlog_template(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def requestlog_template(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "requestlog_template", value)

    @property
    @pulumi.getter(name="responseLogging")
    def response_logging(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def response_logging(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "response_logging", value)

    @property
    @pulumi.getter(name="responselogErrorPool")
    def responselog_error_pool(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def responselog_error_pool(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "responselog_error_pool", value)

    @property
    @pulumi.getter(name="responselogErrorProtocol")
    def responselog_error_protocol(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def responselog_error_protocol(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "responselog_error_protocol", value)

    @property
    @pulumi.getter(name="responselogErrorTemplate")
    def responselog_error_template(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the directives and entries to be logged for request errors.
        """
    ...
    def responselog_error_template(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "responselog_error_template", value)

    @property
    @pulumi.getter(name="responselogPool")
    def responselog_pool(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def responselog_pool(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "responselog_pool", value)

    @property
    @pulumi.getter(name="responselogProtocol")
    def responselog_protocol(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def responselog_protocol(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "responselog_protocol", value)

    @property
    @pulumi.getter(name="responselogTemplate")
    def responselog_template(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the directives and entries to be logged. More infor on responselog_template can be found [here](https://techdocs.f5.com/en-us/bigip-15-0-0/external-monitoring-of-big-ip-systems-implementations/configuring-request-logging.html). how to use can be find [here](https://my.f5.com/manage/s/article/K00847516).
        """
    ...
    def responselog_template(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RequestLogProfile(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            responselog_pool: Optional[pulumi.Input[builtins.str]] = None,
            responselog_protocol: Optional[pulumi.Input[builtins.str]] = None,
            responselog_template: Optional[pulumi.Input[builtins.str]] = None) -> 'RequestLogProfile':
        """
    ...
    @property
    @pulumi.getter(name="proxyResponse")
    def proxy_response(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Defines the pool associated with logging request errors. The default is None.
        """
        return pulumi.get(self, "proxy_response")
    ...
    @property
    @pulumi.getter(name="proxycloseOnError")
    def proxyclose_on_error(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Defines the pool associated with logging request errors. The default is None.
        """
        return pulumi.get(self, "proxyclose_on_error")
    ...
    @property
    @pulumi.getter(name="proxyrespondOnLoggingerror")
    def proxyrespond_on_loggingerror(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Defines the pool associated with logging request errors. The default is None.
        """
        return pulumi.get(self, "proxyrespond_on_loggingerror")
    ...
    @property
    @pulumi.getter(name="requestLogging")
    def request_logging(self) -> pulumi.Output[builtins.str]:
        """
        Enables or disables request logging. The default is `disabled`, possible values are `enabled` and `disabled`.
        """
        return pulumi.get(self, "request_logging")
    ...
    @property
    @pulumi.getter(name="requestlogErrorPool")
    def requestlog_error_pool(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Defines the pool associated with logging request errors. The default is None.
        """
        return pulumi.get(self, "requestlog_error_pool")
    ...
    @property
    @pulumi.getter(name="requestlogErrorProtocol")
    def requestlog_error_protocol(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the protocol to be used for high-speed logging of request errors. The default is `mds-udp`,possible values are `mds-udp` and `mds-tcp`.
        """
        return pulumi.get(self, "requestlog_error_protocol")
    ...
    @property
    @pulumi.getter(name="requestlogErrorTemplate")
    def requestlog_error_template(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the directives and entries to be logged for request errors.
        """
        return pulumi.get(self, "requestlog_error_template")
    ...
    @property
    @pulumi.getter(name="requestlogPool")
    def requestlog_pool(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Defines the pool to send logs to. Typically, the pool will contain one or more syslog servers. It is recommended that you create a pool specifically for logging requests. The default is `none`.
        """
        return pulumi.get(self, "requestlog_pool")
    ...
    @property
    @pulumi.getter(name="requestlogProtocol")
    def requestlog_protocol(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the protocol to be used for high-speed logging of requests. The default is `mds-udp`,possible values are `mds-udp` and `mds-tcp`.
        """
        return pulumi.get(self, "requestlog_protocol")
    ...
    @property
    @pulumi.getter(name="requestlogTemplate")
    def requestlog_template(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the directives and entries to be logged. More infor on requestlog_template can be found [here](https://techdocs.f5.com/en-us/bigip-15-0-0/external-monitoring-of-big-ip-systems-implementations/configuring-request-logging.html). how to use can be find [here](https://my.f5.com/manage/s/article/K00847516).
        """
        return pulumi.get(self, "requestlog_template")
    ...
    @property
    @pulumi.getter(name="responseLogging")
    def response_logging(self) -> pulumi.Output[builtins.str]:
        """
        Enables or disables response logging. The default is `disabled`, possible values are `enabled` and `disabled`.
        """
        return pulumi.get(self, "response_logging")
    ...
    @property
    @pulumi.getter(name="responselogErrorPool")
    def responselog_error_pool(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Defines the pool associated with logging response errors. The default is `none`.
        """
        return pulumi.get(self, "responselog_error_pool")
    ...
    @property
    @pulumi.getter(name="responselogErrorProtocol")
    def responselog_error_protocol(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the protocol to be used for high-speed logging of response errors. The default is `mds-udp`,possible values are `mds-udp` and `mds-tcp`.
        """
        return pulumi.get(self, "responselog_error_protocol")
    ...
    @property
    @pulumi.getter(name="responselogErrorTemplate")
    def responselog_error_template(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the directives and entries to be logged for request errors.
        """
        return pulumi.get(self, "responselog_error_template")
    ...
    @property
    @pulumi.getter(name="responselogPool")
    def responselog_pool(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Defines the pool to send logs to. Typically, the pool contains one or more syslog servers. It is recommended that you create a pool specifically for logging responses. The default is `none`.
        """
        return pulumi.get(self, "responselog_pool")
    ...
    @property
    @pulumi.getter(name="responselogProtocol")
    def responselog_protocol(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the protocol to be used for high-speed logging of responses. The default is `mds-udp`,possible values are `mds-udp` and `mds-tcp`.
        """
        return pulumi.get(self, "responselog_protocol")
    ...
    @property
    @pulumi.getter(name="responselogTemplate")
    def responselog_template(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the directives and entries to be logged. More infor on responselog_template can be found [here](https://techdocs.f5.com/en-us/bigip-15-0-0/external-monitoring-of-big-ip-systems-implementations/configuring-request-logging.html). how to use can be find [here](https://my.f5.com/manage/s/article/K00847516).
        """
        return pulumi.get(self, "responselog_template")
