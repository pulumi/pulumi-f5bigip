...
class GetNodeResult:
    ...
    def dynamic_ratio(self) -> builtins.int:
        """
    ...
    def full_path(self) -> Optional[builtins.str]:
        """
    ...
    def rate_limit(self) -> builtins.str:
        """
        Node rate limit.
        """
...
def get_node(address: Optional[builtins.str] = None,
             description: Optional[builtins.str] = None,
             fqdn: Optional[Union['GetNodeFqdnArgs', 'GetNodeFqdnArgsDict']] = None,
             full_path: Optional[builtins.str] = None,
    ...
    :param builtins.str address: The address of the node.
    :param builtins.str description: User defined description of the node.
    :param builtins.str full_path: Full path of the node (partition and name)
    :param builtins.str name: Name of the node.
    :param builtins.str partition: partition of the node.
    """
    __args__ = dict()
...
def get_node_output(address: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                    ...
                    full_path: Optional[pulumi.Input[Optional[builtins.str]]] = None,
