...
class DataGroupArgs:
    def __init__(__self__, *,
                 ...
                 records_src: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a DataGroup resource.
        :param pulumi.Input[builtins.str] name: Name of the datagroup
        :param pulumi.Input[builtins.str] type: datagroup type (applies to the `name` field of the record), supports: `string`, `ip` or `integer`
        :param pulumi.Input[builtins.bool] internal: Set `false` if you want to Create External Datagroups. default is `true`,means creates internal datagroup.
        ...
        :param pulumi.Input[builtins.str] records_src: Path to a file with records in it,The file should be well-formed,it includes records, one per line,that resemble the following format "key separator value". For example, `foo := bar`.
    ...
    def records_src(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @records_src.setter
    def records_src(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DataGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            records: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DataGroupRecordArgs', 'DataGroupRecordArgsDict']]]]] = None,
            records_src: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'DataGroup':
        """
    ...
    @property
    @pulumi.getter
    def internal(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set `false` if you want to Create External Datagroups. default is `true`,means creates internal datagroup.
        """
        return pulumi.get(self, "internal")
    ...
    @property
    @pulumi.getter(name="recordsSrc")
    def records_src(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Path to a file with records in it,The file should be well-formed,it includes records, one per line,that resemble the following format "key separator value". For example, `foo := bar`.
        This should be used in conjunction with `internal` attribute set `false`
        """
