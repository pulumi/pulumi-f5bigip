...
class ProfileBotDefenseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Name of the Bot Defense profile
        :param pulumi.Input[builtins.str] defaults_from: Specifies the profile from which this profile inherits settings. The default is the system-supplied `request-log`
               profile
        :param pulumi.Input[builtins.str] description: User defined description for Bot Defense profile
        :param pulumi.Input[builtins.str] enforcement_mode: Select the enforcement mode, possible values are `transparent` and `blocking`.
        :param pulumi.Input[builtins.str] template: Profile templates specify Mitigation and Verification Settings default values. possible ptions `balanced`,`relaxed` and
               `strict`
        """
...
class ProfileBotDefense(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            enforcement_mode: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            template: Optional[pulumi.Input[builtins.str]] = None) -> 'ProfileBotDefense':
        """
    ...
    @property
    @pulumi.getter(name="enforcementMode")
    def enforcement_mode(self) -> pulumi.Output[builtins.str]:
        """
        Select the enforcement mode, possible values are `transparent` and `blocking`.
        """
        return pulumi.get(self, "enforcement_mode")
