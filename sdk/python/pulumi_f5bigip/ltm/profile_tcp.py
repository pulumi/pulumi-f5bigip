...
class ProfileTcpArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] deferred_accept: Specifies, when enabled, that the system defers allocation of the connection chain context until the client response is received. This option is useful for dealing with 3-way handshake DOS attacks. The default value is disabled.
        :param pulumi.Input[_builtins.str] delayed_acks: Specifies, when checked (enabled), that the system can send fewer than one ACK (acknowledgment) segment per data segment received. By default, this setting is enabled.
        :param pulumi.Input[_builtins.str] early_retransmit: Enabling this setting allows TCP to assume a packet is lost after fewer than the standard number of duplicate ACKs, if there is no way to send new data and generate more duplicate ACKs.
        :param pulumi.Input[_builtins.str] fast_open: When enabled, permits TCP Fast Open, allowing properly equipped TCP clients to send data with the SYN packet. Default is `enabled`. If `fast_open` set to `enabled`, argument `verified_accept` can't be set to `enabled`.
        :param pulumi.Input[_builtins.int] finwait2timeout: Specifies the number of seconds that a connection is in the FIN-WAIT-2 state before quitting. The default value is 300 seconds. A value of 0 (zero) represents a term of forever (or until the maxrtx of the FIN state).
        :param pulumi.Input[_builtins.int] finwait_timeout: Specifies the number of seconds that a connection is in the FIN-WAIT-1 or closing state before quitting. The default value is 5 seconds. A value of 0 (zero) represents a term of forever (or until the maxrtx of the FIN state). You can also specify immediate or indefinite.
        :param pulumi.Input[_builtins.int] idle_timeout: Specifies the number of seconds that a connection is idle before the connection is eligible for deletion. The default value is 300 seconds.
        :param pulumi.Input[_builtins.int] initial_congestion_windowsize: Specifies the initial congestion window size for connections to this destination. Actual window size is this value multiplied by the MSS (Maximum Segment Size) for the same connection. The default is 10. Valid values range from 0 to 64.
        :param pulumi.Input[_builtins.int] keepalive_interval: Specifies the keep alive probe interval, in seconds. The default value is 1800 seconds.
        :param pulumi.Input[_builtins.str] nagle: Specifies whether the system applies Nagle's algorithm to reduce the number of short segments on the network.If you select Auto, the system determines whether to use Nagle's algorithm based on network conditions. By default, this setting is disabled.
        :param pulumi.Input[_builtins.str] partition: name of partition
        :param pulumi.Input[_builtins.int] proxybuffer_high: Specifies the proxy buffer level, in bytes, at which the receive window is closed.
        :param pulumi.Input[_builtins.int] receive_windowsize: Specifies the maximum advertised RECEIVE window size. This value represents the maximum number of bytes to which the RECEIVE window can scale. The default is 65535 bytes.
        :param pulumi.Input[_builtins.int] send_buffersize: Specifies the SEND window size. The default is 131072 bytes.
        :param pulumi.Input[_builtins.str] tailloss_probe: Enabling this setting allows TCP to send a probe segment to trigger fast recovery instead of recovering a loss via a retransmission timeout,By default, this setting is enabled.
        :param pulumi.Input[_builtins.str] timewait_recycle: Using this setting enabled, the system can recycle a wait-state connection immediately upon receipt of a new connection request instead of having to wait until the connection times out of the wait state. By default, this setting is enabled.
        :param pulumi.Input[_builtins.str] verified_accept: Specifies, when checked (enabled), that the system can actually communicate with the server before establishing a client connection. To determine this, the system sends the server a SYN packet before responding to the client's SYN with a SYN-ACK. When unchecked, the system accepts the client connection before selecting a server to talk to. By default, this setting is `disabled`.
        :param pulumi.Input[_builtins.int] zerowindow_timeout: Specifies the timeout in milliseconds for terminating a connection with an effective zero length TCP transmit window.
        """
...
class ProfileTcp(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="closeWaitTimeout")
    def close_wait_timeout(self) -> pulumi.Output[_builtins.int]:
        """
        Specifies the number of seconds that a connection remains in a LAST-ACK state before quitting. A value of 0 represents a term of forever (or until the maxrtx of the FIN state). The default value is 5 seconds.
        """
        return pulumi.get(self, "close_wait_timeout")
    ...
    @_builtins.property
    @pulumi.getter(name="congestionControl")
    def congestion_control(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies the algorithm to use to share network resources among competing users to reduce congestion. The default is High Speed.
        """
        return pulumi.get(self, "congestion_control")
    ...
    @_builtins.property
    @pulumi.getter(name="deferredAccept")
    def deferred_accept(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies, when enabled, that the system defers allocation of the connection chain context until the client response is received. This option is useful for dealing with 3-way handshake DOS attacks. The default value is disabled.
        """
        return pulumi.get(self, "deferred_accept")
    ...
    @_builtins.property
    @pulumi.getter(name="delayedAcks")
    def delayed_acks(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies, when checked (enabled), that the system can send fewer than one ACK (acknowledgment) segment per data segment received. By default, this setting is enabled.
        """
        return pulumi.get(self, "delayed_acks")
    ...
    @_builtins.property
    @pulumi.getter(name="earlyRetransmit")
    def early_retransmit(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Enabling this setting allows TCP to assume a packet is lost after fewer than the standard number of duplicate ACKs, if there is no way to send new data and generate more duplicate ACKs.
        """
        return pulumi.get(self, "early_retransmit")
    ...
    @_builtins.property
    @pulumi.getter(name="fastOpen")
    def fast_open(self) -> pulumi.Output[_builtins.str]:
        """
        When enabled, permits TCP Fast Open, allowing properly equipped TCP clients to send data with the SYN packet. Default is `enabled`. If `fast_open` set to `enabled`, argument `verified_accept` can't be set to `enabled`.
        """
        return pulumi.get(self, "fast_open")
    ...
    @_builtins.property
    @pulumi.getter
    def finwait2timeout(self) -> pulumi.Output[_builtins.int]:
        """
        Specifies the number of seconds that a connection is in the FIN-WAIT-2 state before quitting. The default value is 300 seconds. A value of 0 (zero) represents a term of forever (or until the maxrtx of the FIN state).
        """
        return pulumi.get(self, "finwait2timeout")
    ...
    @_builtins.property
    @pulumi.getter(name="finwaitTimeout")
    def finwait_timeout(self) -> pulumi.Output[_builtins.int]:
        """
        Specifies the number of seconds that a connection is in the FIN-WAIT-1 or closing state before quitting. The default value is 5 seconds. A value of 0 (zero) represents a term of forever (or until the maxrtx of the FIN state). You can also specify immediate or indefinite.
        """
        return pulumi.get(self, "finwait_timeout")
    ...
    @_builtins.property
    @pulumi.getter(name="initialCongestionWindowsize")
    def initial_congestion_windowsize(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Specifies the initial congestion window size for connections to this destination. Actual window size is this value multiplied by the MSS (Maximum Segment Size) for the same connection. The default is 10. Valid values range from 0 to 64.
        """
        return pulumi.get(self, "initial_congestion_windowsize")
    ...
    @_builtins.property
    @pulumi.getter(name="keepaliveInterval")
    def keepalive_interval(self) -> pulumi.Output[_builtins.int]:
        """
        Specifies the keep alive probe interval, in seconds. The default value is 1800 seconds.
        """
        return pulumi.get(self, "keepalive_interval")
    ...
    @_builtins.property
    @pulumi.getter
    def nagle(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies whether the system applies Nagle's algorithm to reduce the number of short segments on the network.If you select Auto, the system determines whether to use Nagle's algorithm based on network conditions. By default, this setting is disabled.
        """
        return pulumi.get(self, "nagle")
    ...
    @_builtins.property
    @pulumi.getter(name="proxybufferHigh")
    def proxybuffer_high(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Specifies the proxy buffer level, in bytes, at which the receive window is closed.
        """
        return pulumi.get(self, "proxybuffer_high")
    ...
    @_builtins.property
    @pulumi.getter(name="receiveWindowsize")
    def receive_windowsize(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Specifies the maximum advertised RECEIVE window size. This value represents the maximum number of bytes to which the RECEIVE window can scale. The default is 65535 bytes.
        """
        return pulumi.get(self, "receive_windowsize")
    ...
    @_builtins.property
    @pulumi.getter(name="sendBuffersize")
    def send_buffersize(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Specifies the SEND window size. The default is 131072 bytes.
        """
        return pulumi.get(self, "send_buffersize")
    ...
    @_builtins.property
    @pulumi.getter(name="taillossProbe")
    def tailloss_probe(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Enabling this setting allows TCP to send a probe segment to trigger fast recovery instead of recovering a loss via a retransmission timeout,By default, this setting is enabled.
        """
        return pulumi.get(self, "tailloss_probe")
    ...
    @_builtins.property
    @pulumi.getter(name="timewaitRecycle")
    def timewait_recycle(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Using this setting enabled, the system can recycle a wait-state connection immediately upon receipt of a new connection request instead of having to wait until the connection times out of the wait state. By default, this setting is enabled.
        """
        return pulumi.get(self, "timewait_recycle")
    ...
    @_builtins.property
    @pulumi.getter(name="verifiedAccept")
    def verified_accept(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies, when checked (enabled), that the system can actually communicate with the server before establishing a client connection. To determine this, the system sends the server a SYN packet before responding to the client's SYN with a SYN-ACK. When unchecked, the system accepts the client connection before selecting a server to talk to. By default, this setting is `disabled`.
        """
        return pulumi.get(self, "verified_accept")
    ...
    @_builtins.property
    @pulumi.getter(name="zerowindowTimeout")
    def zerowindow_timeout(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Specifies the timeout in milliseconds for terminating a connection with an effective zero length TCP transmit window.
        """
        return pulumi.get(self, "zerowindow_timeout")
