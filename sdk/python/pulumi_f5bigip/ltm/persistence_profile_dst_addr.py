...
class PersistenceProfileDstAddr(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, app_service=None, defaults_from=None, hash_algorithm=None, mask=None, match_across_pools=None, match_across_services=None, match_across_virtuals=None, mirror=None, name=None, override_conn_limit=None, timeout=None, __props__=None, __name__=None, __opts__=None):
        """
        Create a PersistenceProfileDstAddr resource with the given unique name, props, and options.
    ...
    @staticmethod
    def get(resource_name, id, opts=None, app_service=None, defaults_from=None, hash_algorithm=None, mask=None, match_across_pools=None, match_across_services=None, match_across_virtuals=None, mirror=None, name=None, override_conn_limit=None, timeout=None):
        """
