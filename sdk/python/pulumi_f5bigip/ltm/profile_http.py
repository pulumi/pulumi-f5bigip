...
class ProfileHttpArgs:
    def __init__(__self__, *,
                 ...
                 accept_xff: Optional[pulumi.Input[builtins.str]] = None,
                 app_service: Optional[pulumi.Input[builtins.str]] = None,
                 basic_auth_realm: Optional[pulumi.Input[builtins.str]] = None,
                 defaults_from: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 encrypt_cookie_secret: Optional[pulumi.Input[builtins.str]] = None,
                 encrypt_cookies: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 enforcements: Optional[pulumi.Input[Sequence[pulumi.Input['ProfileHttpEnforcementArgs']]]] = None,
                 fallback_host: Optional[pulumi.Input[builtins.str]] = None,
                 fallback_status_codes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 head_erase: Optional[pulumi.Input[builtins.str]] = None,
                 head_insert: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 insert_xforwarded_for: Optional[pulumi.Input[builtins.str]] = None,
                 lws_separator: Optional[pulumi.Input[builtins.str]] = None,
                 lws_width: Optional[pulumi.Input[builtins.int]] = None,
                 oneconnect_transformations: Optional[pulumi.Input[builtins.str]] = None,
                 proxy_type: Optional[pulumi.Input[builtins.str]] = None,
                 redirect_rewrite: Optional[pulumi.Input[builtins.str]] = None,
                 request_chunking: Optional[pulumi.Input[builtins.str]] = None,
                 response_chunking: Optional[pulumi.Input[builtins.str]] = None,
                 response_headers_permitteds: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 server_agent_name: Optional[pulumi.Input[builtins.str]] = None,
                 tm_partition: Optional[pulumi.Input[builtins.str]] = None,
                 via_host_name: Optional[pulumi.Input[builtins.str]] = None,
                 via_request: Optional[pulumi.Input[builtins.str]] = None,
                 via_response: Optional[pulumi.Input[builtins.str]] = None,
                 xff_alternative_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a ProfileHttp resource.
        :param pulumi.Input[builtins.str] name: Specifies the name of the http profile,name of Profile should be full path. Full path is the combination of the `partition + profile name`,For example `/Common/test-http-profile`.
        :param pulumi.Input[builtins.str] accept_xff: Enables or disables trusting the client IP address, and statistics from the client IP address, based on the request's XFF (X-forwarded-for) headers, if they exist.
        :param pulumi.Input[builtins.str] app_service: The application service to which the object belongs.
        :param pulumi.Input[builtins.str] basic_auth_realm: Specifies a quoted string for the basic authentication realm. The system sends this string to a client whenever authorization fails. The default value is `none`
        ...
        :param pulumi.Input[builtins.str] description: Specifies user-defined description.
        :param pulumi.Input[builtins.str] encrypt_cookie_secret: Type a passphrase for cookie encryption. Note: Since it's a sensitive entity idempotency will fail for it in the update call.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] encrypt_cookies: Type the cookie names for the system to encrypt.
        :param pulumi.Input[Sequence[pulumi.Input['ProfileHttpEnforcementArgs']]] enforcements: See Enforcement below for more details.
        :param pulumi.Input[builtins.str] fallback_host: Specifies an HTTP fallback host. HTTP redirection allows you to redirect HTTP traffic to another protocol identifier, host name, port number
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] fallback_status_codes: Specifies one or more three-digit status codes that can be returned by an HTTP server,that should trigger a redirection to the fallback host.
        :param pulumi.Input[builtins.str] head_erase: Specifies the header string that you want to erase from an HTTP request. Default is `none`.
        :param pulumi.Input[builtins.str] head_insert: Specifies a quoted header string that you want to insert into an HTTP request.Default is `none`.
        ...
        :param pulumi.Input[builtins.str] insert_xforwarded_for: Specifies, when enabled, that the system inserts an X-Forwarded-For header in an HTTP request with the client IP address, to use with connection pooling. The default is `Disabled`.
        :param pulumi.Input[builtins.str] lws_separator: Specifies the linear white space (LWS) separator that the system inserts when a header exceeds the maximum width you
               specify in the LWS Maximum Columns setting.
        :param pulumi.Input[builtins.int] lws_width: Specifies the linear white space (LWS) separator that the system inserts when a header exceeds the maximum width you specify in the LWS Maximum Columns setting.
        :param pulumi.Input[builtins.str] oneconnect_transformations: Enables the system to perform HTTP header transformations for the purpose of  keeping server-side connections open. This feature requires configuration of a OneConnect profile
        :param pulumi.Input[builtins.str] proxy_type: Specifies the proxy mode for this profile: reverse, explicit, or transparent. The default is `reverse`.
        :param pulumi.Input[builtins.str] redirect_rewrite: Specifies whether the system rewrites the URIs that are part of HTTP redirect (3XX) responses. The default is `none`.
        :param pulumi.Input[builtins.str] request_chunking: Specifies how the system handles HTTP content that is chunked by a client. The default is `preserve`.
        :param pulumi.Input[builtins.str] response_chunking: Specifies how the system handles HTTP content that is chunked by a server. The default is `selective`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] response_headers_permitteds: Specifies headers that the BIG-IP system allows in an HTTP response.If you are specifying more than one header, separate the headers with a blank space.
        :param pulumi.Input[builtins.str] server_agent_name: Specifies the value of the Server header in responses that the BIG-IP itself generates. The default is BigIP. In order to remove it, "none" string is to be passed. If server_agent_name is commented (or not passed) during the update call, then no changes would be applied and previous value will persist. In order to put default value, we need to pass "BigIP" explicitly.
        :param pulumi.Input[builtins.str] tm_partition: Displays the administrative partition within which this profile resides.
        :param pulumi.Input[builtins.str] via_host_name: Specifies the hostname to include into Via header
        :param pulumi.Input[builtins.str] via_request: Specifies whether to append, remove, or preserve a Via header in an HTTP request
        :param pulumi.Input[builtins.str] via_response: Specifies whether to append, remove, or preserve a Via header in an HTTP request
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] xff_alternative_names: Specifies alternative XFF headers instead of the default X-forwarded-for header.
        """
    ...
    def accept_xff(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @accept_xff.setter
    def accept_xff(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def basic_auth_realm(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def basic_auth_realm(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def encrypt_cookie_secret(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def encrypt_cookie_secret(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "encrypt_cookie_secret", value)

    @property
    @pulumi.getter(name="encryptCookies")
    def encrypt_cookies(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def encrypt_cookies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def fallback_host(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def fallback_host(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "fallback_host", value)

    @property
    @pulumi.getter(name="fallbackStatusCodes")
    def fallback_status_codes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def fallback_status_codes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "fallback_status_codes", value)

    @property
    @pulumi.getter(name="headErase")
    def head_erase(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @head_erase.setter
    def head_erase(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "head_erase", value)

    @property
    @pulumi.getter(name="headInsert")
    def head_insert(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @head_insert.setter
    def head_insert(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def insert_xforwarded_for(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def insert_xforwarded_for(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "insert_xforwarded_for", value)

    @property
    @pulumi.getter(name="lwsSeparator")
    def lws_separator(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def lws_separator(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "lws_separator", value)

    @property
    @pulumi.getter(name="lwsWidth")
    def lws_width(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @lws_width.setter
    def lws_width(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "lws_width", value)

    @property
    @pulumi.getter(name="oneconnectTransformations")
    def oneconnect_transformations(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def oneconnect_transformations(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def redirect_rewrite(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def redirect_rewrite(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "redirect_rewrite", value)

    @property
    @pulumi.getter(name="requestChunking")
    def request_chunking(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def request_chunking(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "request_chunking", value)

    @property
    @pulumi.getter(name="responseChunking")
    def response_chunking(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def response_chunking(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "response_chunking", value)

    @property
    @pulumi.getter(name="responseHeadersPermitteds")
    def response_headers_permitteds(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def response_headers_permitteds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "response_headers_permitteds", value)

    @property
    @pulumi.getter(name="serverAgentName")
    def server_agent_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def server_agent_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "server_agent_name", value)

    @property
    @pulumi.getter(name="tmPartition")
    def tm_partition(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @tm_partition.setter
    def tm_partition(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "tm_partition", value)

    @property
    @pulumi.getter(name="viaHostName")
    def via_host_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def via_host_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "via_host_name", value)

    @property
    @pulumi.getter(name="viaRequest")
    def via_request(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @via_request.setter
    def via_request(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "via_request", value)

    @property
    @pulumi.getter(name="viaResponse")
    def via_response(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies whether to append, remove, or preserve a Via header in an HTTP request
        """
    ...
    @via_response.setter
    def via_response(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "via_response", value)

    @property
    @pulumi.getter(name="xffAlternativeNames")
    def xff_alternative_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def xff_alternative_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class ProfileHttp(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            via_request: Optional[pulumi.Input[builtins.str]] = None,
            via_response: Optional[pulumi.Input[builtins.str]] = None,
            xff_alternative_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'ProfileHttp':
        """
    ...
    @property
    @pulumi.getter(name="acceptXff")
    def accept_xff(self) -> pulumi.Output[builtins.str]:
        """
        Enables or disables trusting the client IP address, and statistics from the client IP address, based on the request's XFF (X-forwarded-for) headers, if they exist.
        """
        return pulumi.get(self, "accept_xff")
    ...
    @property
    @pulumi.getter(name="appService")
    def app_service(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The application service to which the object belongs.
        """
        return pulumi.get(self, "app_service")
    ...
    @property
    @pulumi.getter(name="basicAuthRealm")
    def basic_auth_realm(self) -> pulumi.Output[builtins.str]:
        """
        Specifies a quoted string for the basic authentication realm. The system sends this string to a client whenever authorization fails. The default value is `none`
        """
        return pulumi.get(self, "basic_auth_realm")
    ...
    @property
    @pulumi.getter(name="encryptCookieSecret")
    def encrypt_cookie_secret(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Type a passphrase for cookie encryption. Note: Since it's a sensitive entity idempotency will fail for it in the update call.
        """
        return pulumi.get(self, "encrypt_cookie_secret")
    ...
    @property
    @pulumi.getter(name="encryptCookies")
    def encrypt_cookies(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Type the cookie names for the system to encrypt.
        """
        return pulumi.get(self, "encrypt_cookies")
    ...
    @property
    @pulumi.getter(name="fallbackHost")
    def fallback_host(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies an HTTP fallback host. HTTP redirection allows you to redirect HTTP traffic to another protocol identifier, host name, port number
        """
        return pulumi.get(self, "fallback_host")
    ...
    @property
    @pulumi.getter(name="fallbackStatusCodes")
    def fallback_status_codes(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Specifies one or more three-digit status codes that can be returned by an HTTP server,that should trigger a redirection to the fallback host.
        """
        return pulumi.get(self, "fallback_status_codes")
    ...
    @property
    @pulumi.getter(name="headErase")
    def head_erase(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the header string that you want to erase from an HTTP request. Default is `none`.
        """
        return pulumi.get(self, "head_erase")
    ...
    @property
    @pulumi.getter(name="headInsert")
    def head_insert(self) -> pulumi.Output[builtins.str]:
        """
        Specifies a quoted header string that you want to insert into an HTTP request.Default is `none`.
        """
        return pulumi.get(self, "head_insert")
    ...
    @property
    @pulumi.getter(name="insertXforwardedFor")
    def insert_xforwarded_for(self) -> pulumi.Output[builtins.str]:
        """
        Specifies, when enabled, that the system inserts an X-Forwarded-For header in an HTTP request with the client IP address, to use with connection pooling. The default is `Disabled`.
        """
        return pulumi.get(self, "insert_xforwarded_for")
    ...
    @property
    @pulumi.getter(name="lwsSeparator")
    def lws_separator(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the linear white space (LWS) separator that the system inserts when a header exceeds the maximum width you
        specify in the LWS Maximum Columns setting.
        """
    ...
    @property
    @pulumi.getter(name="lwsWidth")
    def lws_width(self) -> pulumi.Output[builtins.int]:
        """
        Specifies the linear white space (LWS) separator that the system inserts when a header exceeds the maximum width you specify in the LWS Maximum Columns setting.
        """
        return pulumi.get(self, "lws_width")
    ...
    @property
    @pulumi.getter(name="oneconnectTransformations")
    def oneconnect_transformations(self) -> pulumi.Output[builtins.str]:
        """
        Enables the system to perform HTTP header transformations for the purpose of  keeping server-side connections open. This feature requires configuration of a OneConnect profile
        """
        return pulumi.get(self, "oneconnect_transformations")
    ...
    @property
    @pulumi.getter(name="proxyType")
    def proxy_type(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the proxy mode for this profile: reverse, explicit, or transparent. The default is `reverse`.
        """
        return pulumi.get(self, "proxy_type")
    ...
    @property
    @pulumi.getter(name="redirectRewrite")
    def redirect_rewrite(self) -> pulumi.Output[builtins.str]:
        """
        Specifies whether the system rewrites the URIs that are part of HTTP redirect (3XX) responses. The default is `none`.
        """
        return pulumi.get(self, "redirect_rewrite")
    ...
    @property
    @pulumi.getter(name="requestChunking")
    def request_chunking(self) -> pulumi.Output[builtins.str]:
        """
        Specifies how the system handles HTTP content that is chunked by a client. The default is `preserve`.
        """
        return pulumi.get(self, "request_chunking")
    ...
    @property
    @pulumi.getter(name="responseChunking")
    def response_chunking(self) -> pulumi.Output[builtins.str]:
        """
        Specifies how the system handles HTTP content that is chunked by a server. The default is `selective`.
        """
        return pulumi.get(self, "response_chunking")
    ...
    @property
    @pulumi.getter(name="responseHeadersPermitteds")
    def response_headers_permitteds(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Specifies headers that the BIG-IP system allows in an HTTP response.If you are specifying more than one header, separate the headers with a blank space.
        """
        return pulumi.get(self, "response_headers_permitteds")
    ...
    @property
    @pulumi.getter(name="serverAgentName")
    def server_agent_name(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the value of the Server header in responses that the BIG-IP itself generates. The default is BigIP. In order to remove it, "none" string is to be passed. If server_agent_name is commented (or not passed) during the update call, then no changes would be applied and previous value will persist. In order to put default value, we need to pass "BigIP" explicitly.
        """
        return pulumi.get(self, "server_agent_name")
    ...
    @property
    @pulumi.getter(name="tmPartition")
    def tm_partition(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Displays the administrative partition within which this profile resides.
        """
        return pulumi.get(self, "tm_partition")
    ...
    @property
    @pulumi.getter(name="viaHostName")
    def via_host_name(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the hostname to include into Via header
        """
        return pulumi.get(self, "via_host_name")
    ...
    @property
    @pulumi.getter(name="viaRequest")
    def via_request(self) -> pulumi.Output[builtins.str]:
        """
        Specifies whether to append, remove, or preserve a Via header in an HTTP request
        """
        return pulumi.get(self, "via_request")
    ...
    @property
    @pulumi.getter(name="viaResponse")
    def via_response(self) -> pulumi.Output[builtins.str]:
        """
        Specifies whether to append, remove, or preserve a Via header in an HTTP request
        """
        return pulumi.get(self, "via_response")
    ...
    @property
    @pulumi.getter(name="xffAlternativeNames")
    def xff_alternative_names(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Specifies alternative XFF headers instead of the default X-forwarded-for header.
        """
        return pulumi.get(self, "xff_alternative_names")
