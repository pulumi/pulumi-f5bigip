...
class GetMonitorResult:
    ...
    @property
    @pulumi.getter
    def adaptive(self) -> builtins.str:
        """
    ...
    def adaptive_limit(self) -> builtins.int:
        """
        Displays whether adaptive response time monitoring is enabled for this monitor.
        """
    ...
    def chase_referrals(self) -> builtins.str:
    ...
    def defaults_from(self) -> builtins.str:
    ...
    def mandatory_attributes(self) -> builtins.str:
        return pulumi.get(self, "mandatory_attributes")

    @property
    @pulumi.getter(name="manualResume")
    def manual_resume(self) -> builtins.str:
        """
    ...
    def receive_disable(self) -> builtins.str:
    ...
    @property
    @pulumi.getter
    def security(self) -> builtins.str:
        return pulumi.get(self, "security")

    @property
    @pulumi.getter(name="timeUntilUp")
    def time_until_up(self) -> builtins.int:
    ...
    @property
    @pulumi.getter
    def transparent(self) -> builtins.str:
        """
...
def get_monitor(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: Name of the ltm monitor
    :param builtins.str partition: partition of the ltm monitor
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_monitor_output(name: Optional[pulumi.Input[builtins.str]] = None,
