...
class PoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] load_balancing_mode: Specifies the load balancing method. The default is `round-robin`. Possible options: [`dynamic-ratio-member`,`dynamic-ratio-node`, `fastest-app-response`,`fastest-node`, `least-connections-members`,`least-connections-node`,`least-sessions`,`observed-member`,`observed-node`,`predictive-member`,`predictive-node`,`ratio-least-connections-member`,`ratio-least-connections-node`,`ratio-member`,`ratio-node`,`ratio-session`,`round-robin`,`weighted-least-connections-member`,`weighted-least-connections-node`]
        :param pulumi.Input[_builtins.int] minimum_active_members: Specifies whether the system load balances traffic according to the priority number assigned to the pool member,Default Value is `0` meaning `disabled`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] monitors: List of monitor names to associate with the pool
        :param pulumi.Input[_builtins.int] reselect_tries: Specifies the number of times the system tries to contact a new pool member after a passive failure.
        :param pulumi.Input[_builtins.str] service_down_action: Specifies how the system should respond when the target pool member becomes unavailable. The default is `None`, Possible values: `[none, reset, reselect, drop]`.
        :param pulumi.Input[_builtins.int] slow_ramp_time: Specifies the duration during which the system sends less traffic to a newly-enabled pool member.
        """
...
class Pool(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="allowNat")
    def allow_nat(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies whether NATs are automatically enabled or disabled for any connections using this pool, [ Default : `yes`, Possible Values `yes` or `no`].
        """
        return pulumi.get(self, "allow_nat")
    ...
    @_builtins.property
    @pulumi.getter(name="allowSnat")
    def allow_snat(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies whether SNATs are automatically enabled or disabled for any connections using this pool,[ Default : `yes`, Possible Values `yes` or `no`].
        """
        return pulumi.get(self, "allow_snat")
    ...
    @_builtins.property
    @pulumi.getter(name="loadBalancingMode")
    def load_balancing_mode(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies the load balancing method. The default is `round-robin`. Possible options: [`dynamic-ratio-member`,`dynamic-ratio-node`, `fastest-app-response`,`fastest-node`, `least-connections-members`,`least-connections-node`,`least-sessions`,`observed-member`,`observed-node`,`predictive-member`,`predictive-node`,`ratio-least-connections-member`,`ratio-least-connections-node`,`ratio-member`,`ratio-node`,`ratio-session`,`round-robin`,`weighted-least-connections-member`,`weighted-least-connections-node`]
        """
        return pulumi.get(self, "load_balancing_mode")
    ...
    @_builtins.property
    @pulumi.getter(name="minimumActiveMembers")
    def minimum_active_members(self) -> pulumi.Output[_builtins.int]:
        """
        Specifies whether the system load balances traffic according to the priority number assigned to the pool member,Default Value is `0` meaning `disabled`.
        """
        return pulumi.get(self, "minimum_active_members")
    ...
    @_builtins.property
    @pulumi.getter
    def monitors(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        List of monitor names to associate with the pool
        """
        return pulumi.get(self, "monitors")
    ...
    @_builtins.property
    @pulumi.getter(name="reselectTries")
    def reselect_tries(self) -> pulumi.Output[_builtins.int]:
        """
        Specifies the number of times the system tries to contact a new pool member after a passive failure.
        """
        return pulumi.get(self, "reselect_tries")
    ...
    @_builtins.property
    @pulumi.getter(name="serviceDownAction")
    def service_down_action(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies how the system should respond when the target pool member becomes unavailable. The default is `None`, Possible values: `[none, reset, reselect, drop]`.
        """
        return pulumi.get(self, "service_down_action")
    ...
    @_builtins.property
    @pulumi.getter(name="slowRampTime")
    def slow_ramp_time(self) -> pulumi.Output[_builtins.int]:
        """
        Specifies the duration during which the system sends less traffic to a newly-enabled pool member.
        """
        return pulumi.get(self, "slow_ramp_time")
