...
class ProfileHttp2Args:
    def __init__(__self__, *,
                 ...
                 activation_modes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 concurrent_streams_per_connection: Optional[pulumi.Input[builtins.int]] = None,
                 connection_idle_timeout: Optional[pulumi.Input[builtins.int]] = None,
                 defaults_from: Optional[pulumi.Input[builtins.str]] = None,
                 enforce_tls_requirements: Optional[pulumi.Input[builtins.str]] = None,
                 frame_size: Optional[pulumi.Input[builtins.int]] = None,
                 header_table_size: Optional[pulumi.Input[builtins.int]] = None,
                 include_content_length: Optional[pulumi.Input[builtins.str]] = None,
                 insert_header: Optional[pulumi.Input[builtins.str]] = None,
                 insert_header_name: Optional[pulumi.Input[builtins.str]] = None,
                 receive_window: Optional[pulumi.Input[builtins.int]] = None,
                 write_size: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a ProfileHttp2 resource.
        :param pulumi.Input[builtins.str] name: Name of Profile should be full path.The full path is the combination of the `partition + profile name`,For example `/Common/test-http2-profile`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] activation_modes: This setting specifies the condition that will cause the BIG-IP system to handle an incoming connection as an HTTP/2 connection, Allowed values : `[“alpn”]` (or) `[“always”]`.
        :param pulumi.Input[builtins.int] concurrent_streams_per_connection: Specifies how many concurrent requests are allowed to be outstanding on a single HTTP/2 connection.
        :param pulumi.Input[builtins.int] connection_idle_timeout: Specifies the number of seconds that a connection is idle before the connection is eligible for deletion.
        ...
        :param pulumi.Input[builtins.str] enforce_tls_requirements: Enable or disable enforcement of TLS requirements,Allowed Values : `"enabled"/"disabled"` [Default:`"enabled"`].
        :param pulumi.Input[builtins.int] frame_size: The size of the data frames, in bytes, that the HTTP/2 protocol sends to the client. `Default: 2048`.
        :param pulumi.Input[builtins.int] header_table_size: The size of the header table, in KB, for the HTTP headers that the HTTP/2 protocol compresses to save bandwidth.
        :param pulumi.Input[builtins.str] include_content_length: Enable to include content-length in HTTP/2 headers,Default : disabled
        :param pulumi.Input[builtins.str] insert_header: This setting specifies whether the BIG-IP system should add an HTTP header to the HTTP request to show that the request was received over HTTP/2, Allowed Values : `"enabled"/"disabled"` [ Default: `"disabled"`].
        :param pulumi.Input[builtins.str] insert_header_name: This setting specifies the name of the header that the BIG-IP system will add to the HTTP request when the Insert Header is enabled.
        :param pulumi.Input[builtins.int] receive_window: The flow-control size for upload streams, in KB. `Default: 32`.
        :param pulumi.Input[builtins.int] write_size: The total size of combined data frames, in bytes, that the HTTP/2 protocol sends in a single write function. `Default: 16384`".
        """
    ...
    def activation_modes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def activation_modes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "activation_modes", value)

    @property
    @pulumi.getter(name="concurrentStreamsPerConnection")
    def concurrent_streams_per_connection(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def concurrent_streams_per_connection(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "concurrent_streams_per_connection", value)

    @property
    @pulumi.getter(name="connectionIdleTimeout")
    def connection_idle_timeout(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def connection_idle_timeout(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def enforce_tls_requirements(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def enforce_tls_requirements(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "enforce_tls_requirements", value)

    @property
    @pulumi.getter(name="frameSize")
    def frame_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @frame_size.setter
    def frame_size(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "frame_size", value)

    @property
    @pulumi.getter(name="headerTableSize")
    def header_table_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def header_table_size(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "header_table_size", value)

    @property
    @pulumi.getter(name="includeContentLength")
    def include_content_length(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def include_content_length(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "include_content_length", value)

    @property
    @pulumi.getter(name="insertHeader")
    def insert_header(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def insert_header(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "insert_header", value)

    @property
    @pulumi.getter(name="insertHeaderName")
    def insert_header_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def insert_header_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "insert_header_name", value)

    @property
    @pulumi.getter(name="receiveWindow")
    def receive_window(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def receive_window(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "receive_window", value)

    @property
    @pulumi.getter(name="writeSize")
    def write_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @write_size.setter
    def write_size(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ProfileHttp2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            receive_window: Optional[pulumi.Input[builtins.int]] = None,
            write_size: Optional[pulumi.Input[builtins.int]] = None) -> 'ProfileHttp2':
        """
    ...
    @property
    @pulumi.getter(name="activationModes")
    def activation_modes(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        This setting specifies the condition that will cause the BIG-IP system to handle an incoming connection as an HTTP/2 connection, Allowed values : `[“alpn”]` (or) `[“always”]`.
        """
        return pulumi.get(self, "activation_modes")
    ...
    @property
    @pulumi.getter(name="concurrentStreamsPerConnection")
    def concurrent_streams_per_connection(self) -> pulumi.Output[builtins.int]:
        """
        Specifies how many concurrent requests are allowed to be outstanding on a single HTTP/2 connection.
        """
        return pulumi.get(self, "concurrent_streams_per_connection")
    ...
    @property
    @pulumi.getter(name="connectionIdleTimeout")
    def connection_idle_timeout(self) -> pulumi.Output[builtins.int]:
        """
        Specifies the number of seconds that a connection is idle before the connection is eligible for deletion.
        """
        return pulumi.get(self, "connection_idle_timeout")
    ...
    @property
    @pulumi.getter(name="enforceTlsRequirements")
    def enforce_tls_requirements(self) -> pulumi.Output[builtins.str]:
        """
        Enable or disable enforcement of TLS requirements,Allowed Values : `"enabled"/"disabled"` [Default:`"enabled"`].
        """
        return pulumi.get(self, "enforce_tls_requirements")
    ...
    @property
    @pulumi.getter(name="frameSize")
    def frame_size(self) -> pulumi.Output[builtins.int]:
        """
        The size of the data frames, in bytes, that the HTTP/2 protocol sends to the client. `Default: 2048`.
        """
        return pulumi.get(self, "frame_size")
    ...
    @property
    @pulumi.getter(name="headerTableSize")
    def header_table_size(self) -> pulumi.Output[builtins.int]:
        """
        The size of the header table, in KB, for the HTTP headers that the HTTP/2 protocol compresses to save bandwidth.
        """
        return pulumi.get(self, "header_table_size")
    ...
    @property
    @pulumi.getter(name="includeContentLength")
    def include_content_length(self) -> pulumi.Output[builtins.str]:
        """
        Enable to include content-length in HTTP/2 headers,Default : disabled
        """
        return pulumi.get(self, "include_content_length")
    ...
    @property
    @pulumi.getter(name="insertHeader")
    def insert_header(self) -> pulumi.Output[builtins.str]:
        """
        This setting specifies whether the BIG-IP system should add an HTTP header to the HTTP request to show that the request was received over HTTP/2, Allowed Values : `"enabled"/"disabled"` [ Default: `"disabled"`].
        """
        return pulumi.get(self, "insert_header")
    ...
    @property
    @pulumi.getter(name="insertHeaderName")
    def insert_header_name(self) -> pulumi.Output[builtins.str]:
        """
        This setting specifies the name of the header that the BIG-IP system will add to the HTTP request when the Insert Header is enabled.
        """
        return pulumi.get(self, "insert_header_name")
    ...
    @property
    @pulumi.getter(name="receiveWindow")
    def receive_window(self) -> pulumi.Output[builtins.int]:
        """
        The flow-control size for upload streams, in KB. `Default: 32`.
        """
        return pulumi.get(self, "receive_window")
    ...
    @property
    @pulumi.getter(name="writeSize")
    def write_size(self) -> pulumi.Output[builtins.int]:
        """
        The total size of combined data frames, in bytes, that the HTTP/2 protocol sends in a single write function. `Default: 16384`".
        """
        return pulumi.get(self, "write_size")
