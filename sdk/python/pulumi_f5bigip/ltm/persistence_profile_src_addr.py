...
class PersistenceProfileSrcAddrArgs:
    def __init__(__self__, *,
                 ...
                 map_proxies: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def map_proxies(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @map_proxies.setter
    def map_proxies(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class PersistenceProfileSrcAddr(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: pulumi.Input[Optional[_builtins.str]] = None,
            override_conn_limit: pulumi.Input[Optional[_builtins.str]] = None,
            timeout: pulumi.Input[Optional[_builtins.int]] = None) -> 'PersistenceProfileSrcAddr':
        """
