...
class PersistenceProfileSrcAddrArgs:
    def __init__(__self__, *,
                 ...
                 map_proxies: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] hash_algorithm: Specify the hash algorithm
        :param pulumi.Input[builtins.str] map_proxies: To enable _ disable directs all to the same single pool member
        :param pulumi.Input[builtins.str] mask: Identify a range of source IP addresses to manage together as a single source address affinity persistent connection
        ...
        :param pulumi.Input[builtins.str] match_across_virtuals: To enable _ disable match across services with given persistence record
        ...
        if map_proxies is not None:
            pulumi.set(__self__, "map_proxies", map_proxies)
        if mask is not None:
    ...
    def map_proxies(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @map_proxies.setter
    def map_proxies(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "map_proxies", value)
...
@pulumi.input_type
class _PersistenceProfileSrcAddrState:
    def __init__(__self__, *,
                 app_service: Optional[pulumi.Input[builtins.str]] = None,
...
@pulumi.type_token("f5bigip:ltm/persistenceProfileSrcAddr:PersistenceProfileSrcAddr")
class PersistenceProfileSrcAddr(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PersistenceProfileSrcAddrArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["map_proxies"] = map_proxies
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            override_conn_limit: Optional[pulumi.Input[builtins.str]] = None,
            timeout: Optional[pulumi.Input[builtins.int]] = None) -> 'PersistenceProfileSrcAddr':
        """
        ...
        __props__ = _PersistenceProfileSrcAddrState.__new__(_PersistenceProfileSrcAddrState)
    ...
    @property
    @pulumi.getter(name="hashAlgorithm")
    def hash_algorithm(self) -> pulumi.Output[builtins.str]:
        """
        Specify the hash algorithm
        """
        return pulumi.get(self, "hash_algorithm")
    ...
    @property
    @pulumi.getter(name="mapProxies")
    def map_proxies(self) -> pulumi.Output[builtins.str]:
        """
        To enable _ disable directs all to the same single pool member
        """
        return pulumi.get(self, "map_proxies")
