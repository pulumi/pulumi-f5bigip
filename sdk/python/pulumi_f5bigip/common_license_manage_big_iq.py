...
class CommonLicenseManageBigIqArgs:
    def __init__(__self__, *,
                 assignment_type: pulumi.Input[builtins.str],
                 bigiq_address: pulumi.Input[builtins.str],
                 bigiq_password: pulumi.Input[builtins.str],
                 bigiq_user: pulumi.Input[builtins.str],
                 license_poolname: pulumi.Input[builtins.str],
                 bigiq_login_ref: Optional[pulumi.Input[builtins.str]] = None,
                 bigiq_port: Optional[pulumi.Input[builtins.str]] = None,
                 bigiq_token_auth: Optional[pulumi.Input[builtins.bool]] = None,
                 device_license_status: Optional[pulumi.Input[builtins.str]] = None,
                 hypervisor: Optional[pulumi.Input[builtins.str]] = None,
                 key: Optional[pulumi.Input[builtins.str]] = None,
                 mac_address: Optional[pulumi.Input[builtins.str]] = None,
                 skukeyword1: Optional[pulumi.Input[builtins.str]] = None,
                 skukeyword2: Optional[pulumi.Input[builtins.str]] = None,
                 tenant: Optional[pulumi.Input[builtins.str]] = None,
                 unit_of_measure: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a CommonLicenseManageBigIq resource.
        :param pulumi.Input[builtins.str] assignment_type: The type of assignment, which is determined by whether the BIG-IP is unreachable, unmanaged, or managed by BIG-IQ. Possible values: “UNREACHABLE”, “UNMANAGED”, or “MANAGED”.
        :param pulumi.Input[builtins.str] bigiq_address: BIGIQ License Manager IP Address, variable type `string`
        :param pulumi.Input[builtins.str] bigiq_password: BIGIQ License Manager password.  variable type `string`
        :param pulumi.Input[builtins.str] bigiq_user: BIGIQ License Manager username, variable type `string`
        :param pulumi.Input[builtins.str] license_poolname: A name given to the license pool. type `string`
        :param pulumi.Input[builtins.str] bigiq_login_ref: BIGIQ Login reference for token authentication
        :param pulumi.Input[builtins.str] bigiq_port: type `int`, BIGIQ License Manager Port number, specify if port is other than `443`
        :param pulumi.Input[builtins.bool] bigiq_token_auth: type `bool`, if set to `true` enables Token based Authentication,default is `false`
        :param pulumi.Input[builtins.str] device_license_status: Status of Licence Assignment
        :param pulumi.Input[builtins.str] hypervisor: Identifies the platform running the BIG-IP VE. Possible values: “aws”, “azure”, “gce”, “vmware”, “hyperv”, “kvm”, or “xen”. type `string`
        :param pulumi.Input[builtins.str] key: License Assignment is done with specified `key`, supported only with RegKeypool type License assignement. type `string`
        :param pulumi.Input[builtins.str] mac_address: MAC address of the BIG-IP. type `string`
        :param pulumi.Input[builtins.str] skukeyword1: An optional offering name. type `string`
        :param pulumi.Input[builtins.str] skukeyword2: An optional offering name. type `string`
        :param pulumi.Input[builtins.str] tenant: For an unreachable BIG-IP, you can provide an optional description for the assignment in this field.
        :param pulumi.Input[builtins.str] unit_of_measure: The units used to measure billing. For example, “hourly” or “daily”. Type `string`
        """
    ...
    def assignment_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def assignment_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "assignment_type", value)

    @property
    @pulumi.getter(name="bigiqAddress")
    def bigiq_address(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def bigiq_address(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "bigiq_address", value)

    @property
    @pulumi.getter(name="bigiqPassword")
    def bigiq_password(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def bigiq_password(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "bigiq_password", value)

    @property
    @pulumi.getter(name="bigiqUser")
    def bigiq_user(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @bigiq_user.setter
    def bigiq_user(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "bigiq_user", value)

    @property
    @pulumi.getter(name="licensePoolname")
    def license_poolname(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def license_poolname(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "license_poolname", value)

    @property
    @pulumi.getter(name="bigiqLoginRef")
    def bigiq_login_ref(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def bigiq_login_ref(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bigiq_login_ref", value)

    @property
    @pulumi.getter(name="bigiqPort")
    def bigiq_port(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @bigiq_port.setter
    def bigiq_port(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bigiq_port", value)

    @property
    @pulumi.getter(name="bigiqTokenAuth")
    def bigiq_token_auth(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def bigiq_token_auth(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "bigiq_token_auth", value)

    @property
    @pulumi.getter(name="deviceLicenseStatus")
    def device_license_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def device_license_status(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def skukeyword1(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @skukeyword1.setter
    def skukeyword1(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "skukeyword1", value)

    @property
    @pulumi.getter
    def skukeyword2(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        An optional offering name. type `string`
        """
    ...
    @skukeyword2.setter
    def skukeyword2(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def unit_of_measure(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def unit_of_measure(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _CommonLicenseManageBigIqState:
    def __init__(__self__, *,
                 assignment_type: Optional[pulumi.Input[builtins.str]] = None,
                 bigiq_address: Optional[pulumi.Input[builtins.str]] = None,
                 bigiq_login_ref: Optional[pulumi.Input[builtins.str]] = None,
                 bigiq_password: Optional[pulumi.Input[builtins.str]] = None,
                 bigiq_port: Optional[pulumi.Input[builtins.str]] = None,
                 bigiq_token_auth: Optional[pulumi.Input[builtins.bool]] = None,
                 bigiq_user: Optional[pulumi.Input[builtins.str]] = None,
                 device_license_status: Optional[pulumi.Input[builtins.str]] = None,
                 hypervisor: Optional[pulumi.Input[builtins.str]] = None,
                 key: Optional[pulumi.Input[builtins.str]] = None,
                 license_poolname: Optional[pulumi.Input[builtins.str]] = None,
                 mac_address: Optional[pulumi.Input[builtins.str]] = None,
                 skukeyword1: Optional[pulumi.Input[builtins.str]] = None,
                 skukeyword2: Optional[pulumi.Input[builtins.str]] = None,
                 tenant: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="assignmentType")
    def assignment_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of assignment, which is determined by whether the BIG-IP is unreachable, unmanaged, or managed by BIG-IQ. Possible values: “UNREACHABLE”, “UNMANAGED”, or “MANAGED”.
        """
        return pulumi.get(self, "assignment_type")
    ...
    @assignment_type.setter
    def assignment_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "assignment_type", value)

    @property
    @pulumi.getter(name="bigiqAddress")
    def bigiq_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        BIGIQ License Manager IP Address, variable type `string`
        """
        return pulumi.get(self, "bigiq_address")
    ...
    @bigiq_address.setter
    def bigiq_address(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bigiq_address", value)
    ...
    @property
    @pulumi.getter(name="bigiqPassword")
    def bigiq_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        BIGIQ License Manager password.  variable type `string`
        """
        return pulumi.get(self, "bigiq_password")
    ...
    @bigiq_password.setter
    def bigiq_password(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bigiq_password", value)
    ...
    @property
    @pulumi.getter(name="bigiqUser")
    def bigiq_user(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        BIGIQ License Manager username, variable type `string`
        """
        return pulumi.get(self, "bigiq_user")
    ...
    @bigiq_user.setter
    def bigiq_user(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bigiq_user", value)
    ...
    @property
    @pulumi.getter(name="licensePoolname")
    def license_poolname(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A name given to the license pool. type `string`
        """
        return pulumi.get(self, "license_poolname")
    ...
    @license_poolname.setter
    def license_poolname(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "license_poolname", value)
...
class CommonLicenseManageBigIq(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            skukeyword2: Optional[pulumi.Input[builtins.str]] = None,
            tenant: Optional[pulumi.Input[builtins.str]] = None,
            unit_of_measure: Optional[pulumi.Input[builtins.str]] = None) -> 'CommonLicenseManageBigIq':
        """
    ...
    @property
    @pulumi.getter(name="assignmentType")
    def assignment_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of assignment, which is determined by whether the BIG-IP is unreachable, unmanaged, or managed by BIG-IQ. Possible values: “UNREACHABLE”, “UNMANAGED”, or “MANAGED”.
        """
        return pulumi.get(self, "assignment_type")
    ...
    @property
    @pulumi.getter(name="bigiqAddress")
    def bigiq_address(self) -> pulumi.Output[builtins.str]:
        """
        BIGIQ License Manager IP Address, variable type `string`
        """
        return pulumi.get(self, "bigiq_address")
    ...
    @property
    @pulumi.getter(name="bigiqLoginRef")
    def bigiq_login_ref(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        BIGIQ Login reference for token authentication
        """
        return pulumi.get(self, "bigiq_login_ref")
    ...
    @property
    @pulumi.getter(name="bigiqPassword")
    def bigiq_password(self) -> pulumi.Output[builtins.str]:
        """
        BIGIQ License Manager password.  variable type `string`
        """
        return pulumi.get(self, "bigiq_password")
    ...
    @property
    @pulumi.getter(name="bigiqPort")
    def bigiq_port(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        type `int`, BIGIQ License Manager Port number, specify if port is other than `443`
        """
        return pulumi.get(self, "bigiq_port")
    ...
    @property
    @pulumi.getter(name="bigiqTokenAuth")
    def bigiq_token_auth(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        type `bool`, if set to `true` enables Token based Authentication,default is `false`
        """
        return pulumi.get(self, "bigiq_token_auth")
    ...
    @property
    @pulumi.getter(name="bigiqUser")
    def bigiq_user(self) -> pulumi.Output[builtins.str]:
        """
        BIGIQ License Manager username, variable type `string`
        """
        return pulumi.get(self, "bigiq_user")
    ...
    @property
    @pulumi.getter(name="deviceLicenseStatus")
    def device_license_status(self) -> pulumi.Output[builtins.str]:
        """
        Status of Licence Assignment
        """
        return pulumi.get(self, "device_license_status")
    ...
    @property
    @pulumi.getter
    def hypervisor(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Identifies the platform running the BIG-IP VE. Possible values: “aws”, “azure”, “gce”, “vmware”, “hyperv”, “kvm”, or “xen”. type `string`
        """
        return pulumi.get(self, "hypervisor")
    ...
    @property
    @pulumi.getter(name="licensePoolname")
    def license_poolname(self) -> pulumi.Output[builtins.str]:
        """
        A name given to the license pool. type `string`
        """
        return pulumi.get(self, "license_poolname")
    ...
    @property
    @pulumi.getter
    def skukeyword1(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        An optional offering name. type `string`
        """
        return pulumi.get(self, "skukeyword1")
    ...
    @property
    @pulumi.getter
    def skukeyword2(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        An optional offering name. type `string`
        """
        return pulumi.get(self, "skukeyword2")
    ...
    @property
    @pulumi.getter(name="unitOfMeasure")
    def unit_of_measure(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The units used to measure billing. For example, “hourly” or “daily”. Type `string`
        """
        return pulumi.get(self, "unit_of_measure")
