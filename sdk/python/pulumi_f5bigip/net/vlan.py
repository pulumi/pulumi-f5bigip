...
class VlanArgs:
    def __init__(__self__, *,
                 ...
                 cmp_hash: Optional[pulumi.Input[builtins.str]] = None,
                 interfaces: Optional[pulumi.Input[Sequence[pulumi.Input['VlanInterfaceArgs']]]] = None,
                 mtu: Optional[pulumi.Input[builtins.int]] = None,
                 tag: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a Vlan resource.
        :param pulumi.Input[builtins.str] name: Name of the vlan
        :param pulumi.Input[builtins.str] cmp_hash: Specifies how the traffic on the VLAN will be disaggregated. The value selected determines the traffic disaggregation method. possible options: [`default`, `src-ip`, `dst-ip`]
        ...
        :param pulumi.Input[builtins.int] mtu: Specifies the maximum transmission unit (MTU) for traffic on this VLAN. The default value is `1500`.
        :param pulumi.Input[builtins.int] tag: Specifies a number that the system adds into the header of any frame passing through the VLAN.
        """
    ...
    def cmp_hash(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @cmp_hash.setter
    def cmp_hash(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def tag(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @tag.setter
    def tag(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Vlan(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            mtu: Optional[pulumi.Input[builtins.int]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            tag: Optional[pulumi.Input[builtins.int]] = None) -> 'Vlan':
        """
    ...
    @property
    @pulumi.getter(name="cmpHash")
    def cmp_hash(self) -> pulumi.Output[builtins.str]:
        """
        Specifies how the traffic on the VLAN will be disaggregated. The value selected determines the traffic disaggregation method. possible options: [`default`, `src-ip`, `dst-ip`]
        """
        return pulumi.get(self, "cmp_hash")
    ...
    @property
    @pulumi.getter
    def tag(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Specifies a number that the system adds into the header of any frame passing through the VLAN.
        """
        return pulumi.get(self, "tag")
