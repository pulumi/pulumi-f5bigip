...
class GetGceServiceDiscoveryResult:
    ...
    def encoded_credentials(self) -> Optional[builtins.str]:
        return pulumi.get(self, "encoded_credentials")

    @property
    @pulumi.getter(name="gceSdJson")
    def gce_sd_json(self) -> builtins.str:
        """
...
def get_gce_service_discovery(address_realm: Optional[builtins.str] = None,
                              credential_update: Optional[builtins.bool] = None,
                              encoded_credentials: Optional[builtins.str] = None,
    ...
    :param builtins.str encoded_credentials: Base 64 encoded service account credentials JSON.
    ...
    :param builtins.str project_id: For Google Cloud Engine (GCE) only: The ID of the project in which the members are located.
    :param builtins.str region: GCE region in which ADC is running.
...
def get_gce_service_discovery_output(address_realm: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     credential_update: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                     encoded_credentials: Optional[pulumi.Input[Optional[builtins.str]]] = None,
