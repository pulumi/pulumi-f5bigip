...
def get_azure_service_discovery(address_realm: Optional[str] = None,
    ...
    :param int port: (`optional`,type `int`)Port to be used for Azure service discovery,default `80`.
    :param str resource_group: (`Required`,type `string`) Azure Resource Group name.
    :param str subscription_id: (`Required`,type `string`) Azure subscription ID.
