...
class GetAzureServiceDiscoveryResult:
    ...
    def azure_sd_json(self) -> builtins.str:
        """
...
def get_azure_service_discovery(address_realm: Optional[builtins.str] = None,
    ...
    :param builtins.int port: Port to be used for Azure service discovery,default `80`.
...
def get_azure_service_discovery_output(address_realm: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                       ...
                                       tag_value: Optional[pulumi.Input[Optional[builtins.str]]] = None,
