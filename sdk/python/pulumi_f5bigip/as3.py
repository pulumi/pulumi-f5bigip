...
class As3(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 as3_json: pulumi.Input[Optional[_builtins.str]] = None,
                 controls: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 delete_apps: pulumi.Input[Optional[Union['As3DeleteAppsArgs', 'As3DeleteAppsArgsDict', 'outputs.As3DeleteApps']]] = None,
                 ignore_metadata: pulumi.Input[Optional[_builtins.bool]] = None,
                 task_id: pulumi.Input[Optional[_builtins.str]] = None,
                 tenant_filter: pulumi.Input[Optional[_builtins.str]] = None,
                 tenant_list: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `AS3 documentation` - https://clouddocs.f5.com/products/extensions/f5-appsvcs-extension/latest/userguide/composing-a-declaration.html
        ...
        :param pulumi.Input[_builtins.str] as3_json: Path/Filename of Declarative AS3 JSON which is a json file used with builtin ```file``` function
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] controls: A map that allows you to configure specific behavior controls for the AS3 declaration. Each key represents a particular control setting, and the corresponding value defines its configuration.
        :param pulumi.Input[Union['As3DeleteAppsArgs', 'As3DeleteAppsArgsDict', 'outputs.As3DeleteApps']] delete_apps: Block for specifying tenant name and applications to delete from BIG-IP. **Mutually exclusive with `as3_json`**: only one of `delete_apps` or `as3_json` can be set in a resource block.
        :param pulumi.Input[_builtins.bool] ignore_metadata: Set True if you want to ignore metadata changes during update. By default it is set to false
