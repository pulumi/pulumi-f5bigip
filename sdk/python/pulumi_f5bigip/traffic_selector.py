...
class TrafficSelectorArgs:
    def __init__(__self__, *,
                 destination_address: pulumi.Input[builtins.str],
                 name: pulumi.Input[builtins.str],
                 source_address: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 destination_port: Optional[pulumi.Input[builtins.int]] = None,
                 direction: Optional[pulumi.Input[builtins.str]] = None,
                 ip_protocol: Optional[pulumi.Input[builtins.int]] = None,
                 ipsec_policy: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] destination_address: Specifies the host or network IP address to which the application traffic is destined.When creating a new traffic selector, this parameter is required.
        :param pulumi.Input[builtins.str] name: Name of the IPSec traffic-selector,it should be "full path".The full path is the combination of the partition + name of the IPSec traffic-selector.(For example `/Common/test-selector`)
        :param pulumi.Input[builtins.str] source_address: Specifies the host or network IP address from which the application traffic originates.When creating a new traffic selector, this parameter is required.
        :param pulumi.Input[builtins.str] description: Description of the traffic selector.
        :param pulumi.Input[builtins.int] destination_port: Specifies the IP port used by the application. The default value is `All Ports (0)`
        :param pulumi.Input[builtins.str] direction: Specifies whether the traffic selector applies to inbound or outbound traffic, or both. The default value is `Both`.
        :param pulumi.Input[builtins.int] ip_protocol: Specifies the network protocol to use for this traffic. The default value is `All Protocols (255)`
        :param pulumi.Input[builtins.str] ipsec_policy: Specifies the IPsec policy that tells the BIG-IP system how to handle the packets.When creating a new traffic selector, if this parameter is not specified, the default is `default-ipsec-policy`.
        :param pulumi.Input[builtins.int] order: Specifies the order in which traffic is matched, if traffic can be matched to multiple traffic selectors.Traffic is matched to the traffic selector with the highest priority (lowest order number).
               When creating a new traffic selector, if this parameter is not specified, the default is `last`
        :param pulumi.Input[builtins.int] source_port: Specifies the IP port used by the application. The default value is `All Ports (0)`.
        """
    ...
    def destination_address(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def destination_address(self, value: pulumi.Input[builtins.str]):
    ...
    def source_address(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def source_address(self, value: pulumi.Input[builtins.str]):
    ...
    def ip_protocol(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @ip_protocol.setter
    def ip_protocol(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "ip_protocol", value)

    @property
    @pulumi.getter(name="ipsecPolicy")
    def ipsec_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ipsec_policy.setter
    def ipsec_policy(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("f5bigip:index/trafficSelector:TrafficSelector")
class TrafficSelector(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            order: Optional[pulumi.Input[builtins.int]] = None,
            source_address: Optional[pulumi.Input[builtins.str]] = None,
            source_port: Optional[pulumi.Input[builtins.int]] = None) -> 'TrafficSelector':
        """
    ...
    @property
    @pulumi.getter(name="destinationAddress")
    def destination_address(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the host or network IP address to which the application traffic is destined.When creating a new traffic selector, this parameter is required.
        """
        return pulumi.get(self, "destination_address")
    ...
    @property
    @pulumi.getter(name="ipProtocol")
    def ip_protocol(self) -> pulumi.Output[builtins.int]:
        """
        Specifies the network protocol to use for this traffic. The default value is `All Protocols (255)`
        """
        return pulumi.get(self, "ip_protocol")
    ...
    @property
    @pulumi.getter(name="ipsecPolicy")
    def ipsec_policy(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the IPsec policy that tells the BIG-IP system how to handle the packets.When creating a new traffic selector, if this parameter is not specified, the default is `default-ipsec-policy`.
        """
        return pulumi.get(self, "ipsec_policy")
    ...
    @property
    @pulumi.getter(name="sourceAddress")
    def source_address(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the host or network IP address from which the application traffic originates.When creating a new traffic selector, this parameter is required.
        """
        return pulumi.get(self, "source_address")
    ...
    @property
    @pulumi.getter(name="sourcePort")
    def source_port(self) -> pulumi.Output[builtins.int]:
        """
        Specifies the IP port used by the application. The default value is `All Ports (0)`.
        """
        return pulumi.get(self, "source_port")
