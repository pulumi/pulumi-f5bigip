...
class DeviceGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] full_load_on_sync: Specifies if the device-group will perform a full-load upon sync
        :param pulumi.Input[_builtins.int] incremental_config: Specifies the maximum size (in KB) to devote to incremental config sync cached transactions. The default is 1024 KB.
        :param pulumi.Input[_builtins.str] name: Is the name of the device Group
        :param pulumi.Input[_builtins.str] network_failover: Specifies if the device-group will use a network connection for failover
        :param pulumi.Input[_builtins.str] partition: Device administrative partition
        :param pulumi.Input[_builtins.str] save_on_auto_sync: Specifies whether the configuration should be saved upon auto-sync.
        :param pulumi.Input[_builtins.str] type: Specifies if the device-group will be used for failover or resource syncing
        """
...
class DeviceGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 auto_sync: pulumi.Input[Optional[_builtins.str]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 devices: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DeviceGroupDeviceArgs', 'DeviceGroupDeviceArgsDict', 'outputs.DeviceGroupDevice']]]]] = None,
                 full_load_on_sync: pulumi.Input[Optional[_builtins.str]] = None,
                 incremental_config: pulumi.Input[Optional[_builtins.int]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 network_failover: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] auto_sync: Specifies if the device-group will automatically sync configuration data to its members
        :param pulumi.Input[_builtins.str] description: Description of Device group
        :param pulumi.Input[Sequence[pulumi.Input[Union['DeviceGroupDeviceArgs', 'DeviceGroupDeviceArgsDict', 'outputs.DeviceGroupDevice']]]] devices: Name of the device to be included in device group, this need to be configured before using devicegroup resource
        :param pulumi.Input[_builtins.str] full_load_on_sync: Specifies if the device-group will perform a full-load upon sync
        :param pulumi.Input[_builtins.int] incremental_config: Specifies the maximum size (in KB) to devote to incremental config sync cached transactions. The default is 1024 KB.
        :param pulumi.Input[_builtins.str] name: Is the name of the device Group
        :param pulumi.Input[_builtins.str] network_failover: Specifies if the device-group will use a network connection for failover
    ...
    @_builtins.property
    @pulumi.getter(name="autoSync")
    def auto_sync(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies if the device-group will automatically sync configuration data to its members
        """
        return pulumi.get(self, "auto_sync")
    ...
    @_builtins.property
    @pulumi.getter(name="fullLoadOnSync")
    def full_load_on_sync(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies if the device-group will perform a full-load upon sync
        """
        return pulumi.get(self, "full_load_on_sync")
    ...
    @_builtins.property
    @pulumi.getter(name="incrementalConfig")
    def incremental_config(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Specifies the maximum size (in KB) to devote to incremental config sync cached transactions. The default is 1024 KB.
        """
        return pulumi.get(self, "incremental_config")
    ...
    @_builtins.property
    @pulumi.getter(name="networkFailover")
    def network_failover(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies if the device-group will use a network connection for failover
        """
        return pulumi.get(self, "network_failover")
    ...
    @_builtins.property
    @pulumi.getter(name="saveOnAutoSync")
    def save_on_auto_sync(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies whether the configuration should be saved upon auto-sync.
        """
        return pulumi.get(self, "save_on_auto_sync")
