...
class GetWafEntityParameterUrlArgs:
    ...
    @method.setter
    def method(self, value: builtins.str):
...
if not MYPY:
    class GetWafEntityUrlCrossOriginRequestsEnforcementArgsDict(TypedDict):
        ...
        """
        include_subdomains: NotRequired[builtins.bool]
        """
...
class GetWafEntityUrlCrossOriginRequestsEnforcementArgs:
    def __init__(__self__, *,
        ...
        """
        :param builtins.str origin_name: Specifies the name of the origin with which you want to share your data.
        :param builtins.str origin_port: Specifies the port that other web applications are allowed to use to request data from your web application.
        :param builtins.str origin_protocol: Specifies the protocol that other web applications are allowed to use to request data from your web application.
        :param builtins.bool include_subdomains: Determines whether the subdomains are allowed to receive data from the web application.
        """
    ...
    def origin_name(self) -> builtins.str:
        """
        Specifies the name of the origin with which you want to share your data.
        """
    ...
    @origin_name.setter
    def origin_name(self, value: builtins.str):
        pulumi.set(self, "origin_name", value)

    @property
    @pulumi.getter(name="originPort")
    def origin_port(self) -> builtins.str:
        """
        Specifies the port that other web applications are allowed to use to request data from your web application.
        """
    ...
    @origin_port.setter
    def origin_port(self, value: builtins.str):
    ...
    def origin_protocol(self, value: builtins.str):
    ...
    def include_subdomains(self, value: Optional[builtins.bool]):
...
class GetWafEntityUrlMethodOverrideArgs:
    def __init__(__self__, *,
                 ...
                 method: builtins.str):
        """
        :param builtins.bool allow: Specifies that the system allows or disallows a method for this URL
        :param builtins.str method: Specifies an HTTP method.
        """
    ...
    @allow.setter
    def allow(self, value: builtins.bool):
