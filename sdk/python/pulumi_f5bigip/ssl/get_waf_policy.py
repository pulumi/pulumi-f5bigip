...
class GetWafPolicyResult:
    ...
    def policy_json(self) -> builtins.str:
        """
...
def get_waf_policy(policy_id: Optional[builtins.str] = None,
                   policy_json: Optional[builtins.str] = None,
    ...
    :param builtins.str policy_id: ID of the WAF policy deployed in the BIG-IP.
    :param builtins.str policy_json: Exported WAF policy JSON
    """
    __args__ = dict()
...
def get_waf_policy_output(policy_id: Optional[pulumi.Input[builtins.str]] = None,
                          policy_json: Optional[pulumi.Input[Optional[builtins.str]]] = None,
