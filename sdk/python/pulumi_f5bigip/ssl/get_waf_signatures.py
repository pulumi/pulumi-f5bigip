...
class GetWafSignaturesResult:
    ...
    @_builtins.property
    @pulumi.getter
    def accuracy(self) -> _builtins.str:
        """
    ...
    def system_signature_id(self) -> _builtins.str:
        """
...
def get_waf_signatures(accuracy: Optional[_builtins.str] = None,
                       ...
                       system_signature_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str accuracy: The relative detection accuracy of the signature.
    :param _builtins.str description: Description of the signature.
    :param _builtins.str name: Name of the signature as configured on the system.
    :param _builtins.str risk: The relative risk level of the attack that matches this signature.
    :param _builtins.int signature_id: ID of the signature in the BIG-IP WAF database.
    :param _builtins.str system_signature_id: System generated ID of the signature.
    :param _builtins.str type: Type of the signature.
    """
    __args__ = dict()
...
def get_waf_signatures_output(accuracy: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                              ...
                              risk: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                              signature_id: pulumi.Input[Optional[_builtins.int]] = None,
                              system_signature_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
