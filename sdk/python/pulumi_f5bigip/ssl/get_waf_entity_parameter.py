...
def get_waf_entity_parameter(allow_empty_type: Optional[bool] = None,
    ...
    return AwaitableGetWafEntityParameterResult(
        ...
        check_min_value_length=__ret__.check_min_value_length,
        data_type=__ret__.data_type,
        description=__ret__.description,
        enable_regular_expression=__ret__.enable_regular_expression,
        id=__ret__.id,
        is_base64=__ret__.is_base64,
        is_cookie=__ret__.is_cookie,
        is_header=__ret__.is_header,
        json=__ret__.json,
        level=__ret__.level,
        mandatory=__ret__.mandatory,
        metachars_on_parameter_value_check=__ret__.metachars_on_parameter_value_check,
        name=__ret__.name,
        parameter_location=__ret__.parameter_location,
