...
class IAppList(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str encrypted: Name of origin
        :param builtins.str value: Name of origin
        """
...
class IAppMetadata(dict):
    def __init__(__self__, *,
                 persists: Optional[builtins.str] = None,
                 value: Optional[builtins.str] = None):
        """
        :param builtins.str persists: Name of origin
        :param builtins.str value: Name of origin
        """
    ...
    @property
    @pulumi.getter
    def persists(self) -> Optional[builtins.str]:
        """
        Name of origin
        """
...
class IAppTable(dict):
    ...
    def __init__(__self__, *,
                 ...
                 encrypted_columns: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None,
                 rows: Optional[Sequence['outputs.IAppTableRow']] = None):
        """
        :param builtins.str encrypted_columns: Name of origin
        :param builtins.str name: Name of the iApp.
        """
    ...
    def encrypted_columns(self) -> Optional[builtins.str]:
        """
        Name of origin
        """
...
class IAppTableRow(dict):
    def __init__(__self__, *,
                 rows: Optional[Sequence[builtins.str]] = None):
        if rows is not None:
            pulumi.set(__self__, "rows", rows)

    @property
    @pulumi.getter
    def rows(self) -> Optional[Sequence[builtins.str]]:
        return pulumi.get(self, "rows")
