...
class BigIpLicenseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] command: Tmsh command to execute tmsh commands like install
        :param pulumi.Input[builtins.str] registration_key: A unique Key F5 provides for Licensing BIG-IP
        """
...
class BigIpLicense(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            command: Optional[pulumi.Input[builtins.str]] = None,
            registration_key: Optional[pulumi.Input[builtins.str]] = None) -> 'BigIpLicense':
        """
