...
class ProvisionArgs:
    def __init__(__self__, *,
                 ...
                 cpu_ratio: Optional[pulumi.Input[builtins.int]] = None,
                 disk_ratio: Optional[pulumi.Input[builtins.int]] = None,
                 full_path: Optional[pulumi.Input[builtins.str]] = None,
                 level: Optional[pulumi.Input[builtins.str]] = None,
                 memory_ratio: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a Provision resource.
        :param pulumi.Input[builtins.str] name: Name of module to provision in BIG-IP. 
               possible options:
               * afm
               * am
               * apm
               ...
               * swg
               * urldb
        :param pulumi.Input[builtins.int] cpu_ratio: Use this option only when the level option is set to custom.F5 Networks recommends that you do not modify this option. The default value is none
        :param pulumi.Input[builtins.int] disk_ratio: Use this option only when the level option is set to custom.F5 Networks recommends that you do not modify this option. The default value is none
        :param pulumi.Input[builtins.str] level: Sets the provisioning level for the requested modules. Changing the level for one module may require modifying the level of another module. For example, changing one module to `dedicated` requires setting all others to `none`. Setting the level of a module to `none` means the module is not activated.
               default is `nominal`
               possible options:
               * nominal
               * minimum
               * none
               * dedicated
        :param pulumi.Input[builtins.int] memory_ratio: Use this option only when the level option is set to custom.F5 Networks recommends that you do not modify this option. The default value is none
        """
    ...
    def cpu_ratio(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @cpu_ratio.setter
    def cpu_ratio(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "cpu_ratio", value)

    @property
    @pulumi.getter(name="diskRatio")
    def disk_ratio(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Use this option only when the level option is set to custom.F5 Networks recommends that you do not modify this option. The default value is none
        """
    ...
    @disk_ratio.setter
    def disk_ratio(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def memory_ratio(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Use this option only when the level option is set to custom.F5 Networks recommends that you do not modify this option. The default value is none
        """
    ...
    @memory_ratio.setter
    def memory_ratio(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Provision(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            level: Optional[pulumi.Input[builtins.str]] = None,
            memory_ratio: Optional[pulumi.Input[builtins.int]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'Provision':
        """
    ...
    @property
    @pulumi.getter(name="cpuRatio")
    def cpu_ratio(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Use this option only when the level option is set to custom.F5 Networks recommends that you do not modify this option. The default value is none
        """
        return pulumi.get(self, "cpu_ratio")
    ...
    @property
    @pulumi.getter(name="diskRatio")
    def disk_ratio(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Use this option only when the level option is set to custom.F5 Networks recommends that you do not modify this option. The default value is none
        """
        return pulumi.get(self, "disk_ratio")
    ...
    @property
    @pulumi.getter
    def level(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Sets the provisioning level for the requested modules. Changing the level for one module may require modifying the level of another module. For example, changing one module to `dedicated` requires setting all others to `none`. Setting the level of a module to `none` means the module is not activated.
        default is `nominal`
        possible options:
    ...
    @property
    @pulumi.getter(name="memoryRatio")
    def memory_ratio(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Use this option only when the level option is set to custom.F5 Networks recommends that you do not modify this option. The default value is none
        """
        return pulumi.get(self, "memory_ratio")
