...
class NtpArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] servers: Specifies the time servers that the system uses to update the system time.
        :param pulumi.Input[builtins.str] timezone: Specifies the time zone that you want to use for the system time.
        """
...
class Ntp(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[builtins.str]] = None,
            servers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            timezone: Optional[pulumi.Input[builtins.str]] = None) -> 'Ntp':
        """
