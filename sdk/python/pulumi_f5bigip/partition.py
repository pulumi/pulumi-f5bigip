...
class PartitionArgs:
    def __init__(__self__, *,
                 ...
                 route_domain_id: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a Partition resource.
        :param pulumi.Input[builtins.str] name: Name of the partition.
        :param pulumi.Input[builtins.str] description: Description of the partition.
        :param pulumi.Input[builtins.int] route_domain_id: Route domain id of the partition.
        """
    ...
    def route_domain_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def route_domain_id(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Partition(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            route_domain_id: Optional[pulumi.Input[builtins.int]] = None) -> 'Partition':
        """
    ...
    @property
    @pulumi.getter(name="routeDomainId")
    def route_domain_id(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Route domain id of the partition.
        """
        return pulumi.get(self, "route_domain_id")
