...
class NetIkePeerArgs:
    def __init__(__self__, *,
                 ...
                 generate_policy: Optional[pulumi.Input[builtins.str]] = None,
                 lifetime: Optional[pulumi.Input[builtins.int]] = None,
                 mode: Optional[pulumi.Input[builtins.str]] = None,
                 my_cert_file: Optional[pulumi.Input[builtins.str]] = None,
                 my_cert_key_file: Optional[pulumi.Input[builtins.str]] = None,
                 my_cert_key_passphrase: Optional[pulumi.Input[builtins.str]] = None,
                 my_id_type: Optional[pulumi.Input[builtins.str]] = None,
                 my_id_value: Optional[pulumi.Input[builtins.str]] = None,
                 nat_traversal: Optional[pulumi.Input[builtins.str]] = None,
                 passive: Optional[pulumi.Input[builtins.str]] = None,
                 peers_cert_file: Optional[pulumi.Input[builtins.str]] = None,
                 peers_cert_type: Optional[pulumi.Input[builtins.str]] = None,
                 peers_id_type: Optional[pulumi.Input[builtins.str]] = None,
                 peers_id_value: Optional[pulumi.Input[builtins.str]] = None,
                 phase1_auth_method: Optional[pulumi.Input[builtins.str]] = None,
                 phase1_encrypt_algorithm: Optional[pulumi.Input[builtins.str]] = None,
                 phase1_hash_algorithm: Optional[pulumi.Input[builtins.str]] = None,
                 phase1_perfect_forward_secrecy: Optional[pulumi.Input[builtins.str]] = None,
                 preshared_key: Optional[pulumi.Input[builtins.str]] = None,
                 preshared_key_encrypted: Optional[pulumi.Input[builtins.str]] = None,
                 prf: Optional[pulumi.Input[builtins.str]] = None,
                 proxy_support: Optional[pulumi.Input[builtins.str]] = None,
                 replay_window_size: Optional[pulumi.Input[builtins.int]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None,
                 traffic_selectors: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 verify_cert: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] name: Name of the ike_peer
        :param pulumi.Input[builtins.str] remote_address: Specifies the IP address of the IKE remote node
        :param pulumi.Input[builtins.str] app_service: The application service that the object belongs to
        :param pulumi.Input[builtins.str] ca_cert_file: the trusted root and intermediate certificate authorities
        :param pulumi.Input[builtins.str] crl_file: Specifies the file name of the Certificate Revocation List. Only supported in IKEv1
        :param pulumi.Input[builtins.str] description: User defined description
        :param pulumi.Input[builtins.int] dpd_delay: Specifies the number of seconds between Dead Peer Detection messages
        :param pulumi.Input[builtins.str] generate_policy: Enable or disable the generation of Security Policy Database entries(SPD) when the device is the responder of the IKE remote node
        :param pulumi.Input[builtins.int] lifetime: Defines the lifetime in minutes of an IKE SA which will be proposed in the phase 1 negotiations
        :param pulumi.Input[builtins.str] mode: Defines the exchange mode for phase 1 when racoon is the initiator, or the acceptable exchange mode when racoon is the responder
        :param pulumi.Input[builtins.str] my_cert_file: Specifies the name of the certificate file object
        :param pulumi.Input[builtins.str] my_cert_key_file: Specifies the name of the certificate key file object
        :param pulumi.Input[builtins.str] my_cert_key_passphrase: Specifies the passphrase of the key used for my-cert-key-file
        :param pulumi.Input[builtins.str] my_id_type: Specifies the identifier type sent to the remote host to use in the phase 1 negotiation
        :param pulumi.Input[builtins.str] my_id_value: Specifies the identifier value sent to the remote host in the phase 1 negotiation
        :param pulumi.Input[builtins.str] nat_traversal: Enables use of the NAT-Traversal IPsec extension
        :param pulumi.Input[builtins.str] passive: Specifies whether the local IKE agent can be the initiator of the IKE negotiation with this ike-peer
        :param pulumi.Input[builtins.str] peers_cert_file: Specifies the peer’s certificate for authentication
        :param pulumi.Input[builtins.str] peers_cert_type: Specifies that the only peers-cert-type supported is certfile
        :param pulumi.Input[builtins.str] peers_id_type: Specifies which of address, fqdn, asn1dn, user-fqdn or keyid-tag types to use as peers-id-type
        :param pulumi.Input[builtins.str] peers_id_value: Specifies the peer’s identifier to be received
        :param pulumi.Input[builtins.str] phase1_auth_method: Specifies the authentication method used for phase 1 negotiation
        :param pulumi.Input[builtins.str] phase1_encrypt_algorithm: Specifies the encryption algorithm used for the isakmp phase 1 negotiation
        :param pulumi.Input[builtins.str] phase1_hash_algorithm: Defines the hash algorithm used for the isakmp phase 1 negotiation
        :param pulumi.Input[builtins.str] phase1_perfect_forward_secrecy: Defines the Diffie-Hellman group for key exchange to provide perfect forward secrecy
        :param pulumi.Input[builtins.str] preshared_key: Specifies the preshared key for ISAKMP SAs
        :param pulumi.Input[builtins.str] preshared_key_encrypted: Display the encrypted preshared-key for the IKE remote node
        :param pulumi.Input[builtins.str] prf: Specifies the pseudo-random function used to derive keying material for all cryptographic operations
        :param pulumi.Input[builtins.str] proxy_support: If this value is enabled, both values of ID payloads in the phase 2 exchange are used as the addresses of end-point of IPsec-SAs
        :param pulumi.Input[builtins.int] replay_window_size: Specifies the replay window size of the IPsec SAs negotiated with the IKE remote node
        :param pulumi.Input[builtins.str] state: Enables or disables this IKE remote node
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] traffic_selectors: Specifies the names of the traffic-selector objects associated with this ike-peer
        :param pulumi.Input[builtins.str] verify_cert: Specifies whether to verify the certificate chain of the remote peer based on the trusted certificates in ca-cert-file
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] versions: Specifies which version of IKE to be used
        """
    ...
    def generate_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def generate_policy(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def my_cert_file(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @my_cert_file.setter
    def my_cert_file(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "my_cert_file", value)

    @property
    @pulumi.getter(name="myCertKeyFile")
    def my_cert_key_file(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def my_cert_key_file(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "my_cert_key_file", value)

    @property
    @pulumi.getter(name="myCertKeyPassphrase")
    def my_cert_key_passphrase(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def my_cert_key_passphrase(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "my_cert_key_passphrase", value)

    @property
    @pulumi.getter(name="myIdType")
    def my_id_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @my_id_type.setter
    def my_id_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "my_id_type", value)

    @property
    @pulumi.getter(name="myIdValue")
    def my_id_value(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @my_id_value.setter
    def my_id_value(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "my_id_value", value)

    @property
    @pulumi.getter(name="natTraversal")
    def nat_traversal(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def nat_traversal(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "nat_traversal", value)

    @property
    @pulumi.getter
    def passive(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @passive.setter
    def passive(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "passive", value)

    @property
    @pulumi.getter(name="peersCertFile")
    def peers_cert_file(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def peers_cert_file(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "peers_cert_file", value)

    @property
    @pulumi.getter(name="peersCertType")
    def peers_cert_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def peers_cert_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "peers_cert_type", value)

    @property
    @pulumi.getter(name="peersIdType")
    def peers_id_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def peers_id_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "peers_id_type", value)

    @property
    @pulumi.getter(name="peersIdValue")
    def peers_id_value(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def peers_id_value(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "peers_id_value", value)

    @property
    @pulumi.getter(name="phase1AuthMethod")
    def phase1_auth_method(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def phase1_auth_method(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "phase1_auth_method", value)

    @property
    @pulumi.getter(name="phase1EncryptAlgorithm")
    def phase1_encrypt_algorithm(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def phase1_encrypt_algorithm(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "phase1_encrypt_algorithm", value)

    @property
    @pulumi.getter(name="phase1HashAlgorithm")
    def phase1_hash_algorithm(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def phase1_hash_algorithm(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "phase1_hash_algorithm", value)

    @property
    @pulumi.getter(name="phase1PerfectForwardSecrecy")
    def phase1_perfect_forward_secrecy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def phase1_perfect_forward_secrecy(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "phase1_perfect_forward_secrecy", value)

    @property
    @pulumi.getter(name="presharedKey")
    def preshared_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def preshared_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "preshared_key", value)

    @property
    @pulumi.getter(name="presharedKeyEncrypted")
    def preshared_key_encrypted(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def preshared_key_encrypted(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "preshared_key_encrypted", value)

    @property
    @pulumi.getter
    def prf(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @prf.setter
    def prf(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "prf", value)

    @property
    @pulumi.getter(name="proxySupport")
    def proxy_support(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def proxy_support(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "proxy_support", value)

    @property
    @pulumi.getter(name="replayWindowSize")
    def replay_window_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def replay_window_size(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def traffic_selectors(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def traffic_selectors(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "traffic_selectors", value)

    @property
    @pulumi.getter(name="verifyCert")
    def verify_cert(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @verify_cert.setter
    def verify_cert(self, value: Optional[pulumi.Input[builtins.str]]):
...
class NetIkePeer(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            traffic_selectors: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            verify_cert: Optional[pulumi.Input[builtins.str]] = None,
            versions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'NetIkePeer':
        """
    ...
    @property
    @pulumi.getter(name="caCertFile")
    def ca_cert_file(self) -> pulumi.Output[builtins.str]:
        """
        the trusted root and intermediate certificate authorities
        """
        return pulumi.get(self, "ca_cert_file")
    ...
    @property
    @pulumi.getter(name="dpdDelay")
    def dpd_delay(self) -> pulumi.Output[builtins.int]:
        """
        Specifies the number of seconds between Dead Peer Detection messages
        """
        return pulumi.get(self, "dpd_delay")
    ...
    @property
    @pulumi.getter(name="generatePolicy")
    def generate_policy(self) -> pulumi.Output[builtins.str]:
        """
        Enable or disable the generation of Security Policy Database entries(SPD) when the device is the responder of the IKE remote node
        """
        return pulumi.get(self, "generate_policy")
    ...
    @property
    @pulumi.getter(name="myCertFile")
    def my_cert_file(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the name of the certificate file object
        """
        return pulumi.get(self, "my_cert_file")
    ...
    @property
    @pulumi.getter(name="myCertKeyFile")
    def my_cert_key_file(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the name of the certificate key file object
        """
        return pulumi.get(self, "my_cert_key_file")
    ...
    @property
    @pulumi.getter(name="myCertKeyPassphrase")
    def my_cert_key_passphrase(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the passphrase of the key used for my-cert-key-file
        """
        return pulumi.get(self, "my_cert_key_passphrase")
    ...
    @property
    @pulumi.getter(name="myIdType")
    def my_id_type(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the identifier type sent to the remote host to use in the phase 1 negotiation
        """
        return pulumi.get(self, "my_id_type")
    ...
    @property
    @pulumi.getter(name="myIdValue")
    def my_id_value(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the identifier value sent to the remote host in the phase 1 negotiation
        """
        return pulumi.get(self, "my_id_value")
    ...
    @property
    @pulumi.getter(name="natTraversal")
    def nat_traversal(self) -> pulumi.Output[builtins.str]:
        """
        Enables use of the NAT-Traversal IPsec extension
        """
        return pulumi.get(self, "nat_traversal")
    ...
    @property
    @pulumi.getter
    def passive(self) -> pulumi.Output[builtins.str]:
        """
        Specifies whether the local IKE agent can be the initiator of the IKE negotiation with this ike-peer
        """
        return pulumi.get(self, "passive")
    ...
    @property
    @pulumi.getter(name="peersCertFile")
    def peers_cert_file(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the peer’s certificate for authentication
        """
        return pulumi.get(self, "peers_cert_file")
    ...
    @property
    @pulumi.getter(name="peersCertType")
    def peers_cert_type(self) -> pulumi.Output[builtins.str]:
        """
        Specifies that the only peers-cert-type supported is certfile
        """
        return pulumi.get(self, "peers_cert_type")
    ...
    @property
    @pulumi.getter(name="peersIdType")
    def peers_id_type(self) -> pulumi.Output[builtins.str]:
        """
        Specifies which of address, fqdn, asn1dn, user-fqdn or keyid-tag types to use as peers-id-type
        """
        return pulumi.get(self, "peers_id_type")
    ...
    @property
    @pulumi.getter(name="peersIdValue")
    def peers_id_value(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the peer’s identifier to be received
        """
        return pulumi.get(self, "peers_id_value")
    ...
    @property
    @pulumi.getter(name="phase1AuthMethod")
    def phase1_auth_method(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the authentication method used for phase 1 negotiation
        """
        return pulumi.get(self, "phase1_auth_method")
    ...
    @property
    @pulumi.getter(name="phase1EncryptAlgorithm")
    def phase1_encrypt_algorithm(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the encryption algorithm used for the isakmp phase 1 negotiation
        """
        return pulumi.get(self, "phase1_encrypt_algorithm")
    ...
    @property
    @pulumi.getter(name="phase1HashAlgorithm")
    def phase1_hash_algorithm(self) -> pulumi.Output[builtins.str]:
        """
        Defines the hash algorithm used for the isakmp phase 1 negotiation
        """
        return pulumi.get(self, "phase1_hash_algorithm")
    ...
    @property
    @pulumi.getter(name="phase1PerfectForwardSecrecy")
    def phase1_perfect_forward_secrecy(self) -> pulumi.Output[builtins.str]:
        """
        Defines the Diffie-Hellman group for key exchange to provide perfect forward secrecy
        """
        return pulumi.get(self, "phase1_perfect_forward_secrecy")
    ...
    @property
    @pulumi.getter(name="presharedKey")
    def preshared_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the preshared key for ISAKMP SAs
        """
        return pulumi.get(self, "preshared_key")
    ...
    @property
    @pulumi.getter(name="presharedKeyEncrypted")
    def preshared_key_encrypted(self) -> pulumi.Output[builtins.str]:
        """
        Display the encrypted preshared-key for the IKE remote node
        """
        return pulumi.get(self, "preshared_key_encrypted")
    ...
    @property
    @pulumi.getter
    def prf(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the pseudo-random function used to derive keying material for all cryptographic operations
        """
        return pulumi.get(self, "prf")
    ...
    @property
    @pulumi.getter(name="proxySupport")
    def proxy_support(self) -> pulumi.Output[builtins.str]:
        """
        If this value is enabled, both values of ID payloads in the phase 2 exchange are used as the addresses of end-point of IPsec-SAs
        """
        return pulumi.get(self, "proxy_support")
    ...
    @property
    @pulumi.getter(name="replayWindowSize")
    def replay_window_size(self) -> pulumi.Output[builtins.int]:
        """
        Specifies the replay window size of the IPsec SAs negotiated with the IKE remote node
        """
        return pulumi.get(self, "replay_window_size")
    ...
    @property
    @pulumi.getter(name="trafficSelectors")
    def traffic_selectors(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Specifies the names of the traffic-selector objects associated with this ike-peer
        """
        return pulumi.get(self, "traffic_selectors")
    ...
    @property
    @pulumi.getter(name="verifyCert")
    def verify_cert(self) -> pulumi.Output[builtins.str]:
        """
        Specifies whether to verify the certificate chain of the remote peer based on the trusted certificates in ca-cert-file
        """
        return pulumi.get(self, "verify_cert")
