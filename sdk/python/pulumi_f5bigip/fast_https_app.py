...
class FastHttpsAppArgs:
    def __init__(__self__, *,
                 ...
                 endpoint_ltm_policies: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 existing_tls_client_profile: Optional[pulumi.Input[builtins.str]] = None,
                 existing_tls_server_profile: Optional[pulumi.Input[builtins.str]] = None,
                 existing_waf_security_policy: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 service_discoveries: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] application: Name of the FAST HTTPS application.
        :param pulumi.Input[builtins.str] tenant: Name of the FAST HTTPS application tenant.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] endpoint_ltm_policies: List of LTM Policies to be applied FAST HTTPS Application.
        :param pulumi.Input[builtins.str] existing_monitor: Name of an existing BIG-IP HTTPS pool monitor. Monitors are used to determine the health of the application on each server.
        ...
        :param pulumi.Input[builtins.str] existing_tls_client_profile: Name of an existing TLS client profile.
        :param pulumi.Input[builtins.str] existing_tls_server_profile: Name of an existing TLS server profile.
        :param pulumi.Input[builtins.str] existing_waf_security_policy: Name of an existing WAF Security policy.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_log_profiles: List of security log profiles to be used for FAST application
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] service_discoveries: List of different cloud service discovery config provided as string, provided `service_discovery` block to Automatically Discover Pool Members with Service Discovery on different clouds.
    ...
    def endpoint_ltm_policies(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def endpoint_ltm_policies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def existing_tls_client_profile(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def existing_tls_client_profile(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "existing_tls_client_profile", value)

    @property
    @pulumi.getter(name="existingTlsServerProfile")
    def existing_tls_server_profile(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def existing_tls_server_profile(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "existing_tls_server_profile", value)

    @property
    @pulumi.getter(name="existingWafSecurityPolicy")
    def existing_waf_security_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def existing_waf_security_policy(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def service_discoveries(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def service_discoveries(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _FastHttpsAppState:
    def __init__(__self__, *,
                 ...
                 existing_waf_security_policy: Optional[pulumi.Input[builtins.str]] = None,
                 fallback_persistence: Optional[pulumi.Input[builtins.str]] = None,
                 fast_https_json: Optional[pulumi.Input[builtins.str]] = None,
                 load_balancing_mode: Optional[pulumi.Input[builtins.str]] = None,
                 monitor: Optional[pulumi.Input['FastHttpsAppMonitorArgs']] = None,
                 persistence_profile: Optional[pulumi.Input[builtins.str]] = None,
                 persistence_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] existing_waf_security_policy: Name of an existing WAF Security policy.
        :param pulumi.Input[builtins.str] fallback_persistence: Type of fallback persistence record to be created for each new client connection.
        :param pulumi.Input[builtins.str] fast_https_json: Json payload for FAST HTTPS application.
        :param pulumi.Input[builtins.str] load_balancing_mode: A `load balancing method` is an algorithm that the BIG-IP system uses to select a pool member for processing a request. F5 recommends the Least Connections load balancing method
        :param pulumi.Input['FastHttpsAppMonitorArgs'] monitor: `monitor` block takes input for FAST-Generated Pool Monitor.
               See Pool Monitor below for more details.
        :param pulumi.Input[builtins.str] persistence_profile: Name of an existing BIG-IP persistence profile to be used.
    ...
    def fast_https_json(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def fast_https_json(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FastHttpsApp(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="endpointLtmPolicies")
    def endpoint_ltm_policies(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of LTM Policies to be applied FAST HTTPS Application.
        """
        return pulumi.get(self, "endpoint_ltm_policies")
    ...
    @property
    @pulumi.getter(name="existingTlsClientProfile")
    def existing_tls_client_profile(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of an existing TLS client profile.
        """
        return pulumi.get(self, "existing_tls_client_profile")
    ...
    @property
    @pulumi.getter(name="existingTlsServerProfile")
    def existing_tls_server_profile(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of an existing TLS server profile.
        """
        return pulumi.get(self, "existing_tls_server_profile")
    ...
    @property
    @pulumi.getter(name="existingWafSecurityPolicy")
    def existing_waf_security_policy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of an existing WAF Security policy.
        """
        return pulumi.get(self, "existing_waf_security_policy")
    ...
    @property
    @pulumi.getter(name="fastHttpsJson")
    def fast_https_json(self) -> pulumi.Output[builtins.str]:
        """
        Json payload for FAST HTTPS application.
        """
        return pulumi.get(self, "fast_https_json")
    ...
    @property
    @pulumi.getter(name="serviceDiscoveries")
    def service_discoveries(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of different cloud service discovery config provided as string, provided `service_discovery` block to Automatically Discover Pool Members with Service Discovery on different clouds.
        """
        return pulumi.get(self, "service_discoveries")
