...
class DoArgs:
    def __init__(__self__, *,
                 do_json: pulumi.Input[builtins.str],
                 bigip_address: Optional[pulumi.Input[builtins.str]] = None,
                 bigip_password: Optional[pulumi.Input[builtins.str]] = None,
                 bigip_port: Optional[pulumi.Input[builtins.str]] = None,
                 bigip_token_auth: Optional[pulumi.Input[builtins.bool]] = None,
                 bigip_user: Optional[pulumi.Input[builtins.str]] = None,
                 tenant_name: Optional[pulumi.Input[builtins.str]] = None,
                 timeout: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a Do resource.
        :param pulumi.Input[builtins.str] do_json: Name of the of the Declarative DO JSON file
        :param pulumi.Input[builtins.str] bigip_address: IP Address of BIGIP Host to be used for this resource,this is optional parameter.
               whenever we specify this parameter it gets overwrite provider configuration
        :param pulumi.Input[builtins.str] bigip_password: Password of BIGIP host to be used for this resource
        :param pulumi.Input[builtins.str] bigip_port: Port number of BIGIP host to be used for this resource,this is optional parameter.
               whenever we specify this parameter it gets overwrite provider configuration
        :param pulumi.Input[builtins.bool] bigip_token_auth: Enable to use an external authentication source (LDAP, TACACS, etc)
        :param pulumi.Input[builtins.str] bigip_user: UserName of BIGIP host to be used for this resource,this is optional parameter.
               whenever we specify this parameter it gets overwrite provider configuration
        :param pulumi.Input[builtins.str] tenant_name: unique identifier for DO resource
        :param pulumi.Input[builtins.int] timeout: DO json
        """
    ...
    def do_json(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @do_json.setter
    def do_json(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "do_json", value)

    @property
    @pulumi.getter(name="bigipAddress")
    def bigip_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def bigip_address(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bigip_address", value)

    @property
    @pulumi.getter(name="bigipPassword")
    def bigip_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def bigip_password(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bigip_password", value)

    @property
    @pulumi.getter(name="bigipPort")
    def bigip_port(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @bigip_port.setter
    def bigip_port(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bigip_port", value)

    @property
    @pulumi.getter(name="bigipTokenAuth")
    def bigip_token_auth(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def bigip_token_auth(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "bigip_token_auth", value)

    @property
    @pulumi.getter(name="bigipUser")
    def bigip_user(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @bigip_user.setter
    def bigip_user(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DoState:
    def __init__(__self__, *,
                 ...
                 bigip_token_auth: Optional[pulumi.Input[builtins.bool]] = None,
                 bigip_user: Optional[pulumi.Input[builtins.str]] = None,
                 do_json: Optional[pulumi.Input[builtins.str]] = None,
                 tenant_name: Optional[pulumi.Input[builtins.str]] = None,
                 timeout: Optional[pulumi.Input[builtins.int]] = None):
        """
    ...
    @property
    @pulumi.getter(name="doJson")
    def do_json(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Name of the of the Declarative DO JSON file
        """
        return pulumi.get(self, "do_json")
    ...
    @do_json.setter
    def do_json(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "do_json", value)
...
class Do(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            do_json: Optional[pulumi.Input[builtins.str]] = None,
            tenant_name: Optional[pulumi.Input[builtins.str]] = None,
            timeout: Optional[pulumi.Input[builtins.int]] = None) -> 'Do':
        """
    ...
    @property
    @pulumi.getter(name="bigipAddress")
    def bigip_address(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        IP Address of BIGIP Host to be used for this resource,this is optional parameter.
        whenever we specify this parameter it gets overwrite provider configuration
        """
    ...
    @property
    @pulumi.getter(name="bigipPassword")
    def bigip_password(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Password of BIGIP host to be used for this resource
        """
        return pulumi.get(self, "bigip_password")
    ...
    @property
    @pulumi.getter(name="bigipPort")
    def bigip_port(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Port number of BIGIP host to be used for this resource,this is optional parameter.
        whenever we specify this parameter it gets overwrite provider configuration
        """
    ...
    @property
    @pulumi.getter(name="bigipTokenAuth")
    def bigip_token_auth(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable to use an external authentication source (LDAP, TACACS, etc)
        """
        return pulumi.get(self, "bigip_token_auth")
    ...
    @property
    @pulumi.getter(name="bigipUser")
    def bigip_user(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        UserName of BIGIP host to be used for this resource,this is optional parameter.
        whenever we specify this parameter it gets overwrite provider configuration
        """
    ...
    @property
    @pulumi.getter(name="doJson")
    def do_json(self) -> pulumi.Output[builtins.str]:
        """
        Name of the of the Declarative DO JSON file
        """
        return pulumi.get(self, "do_json")
