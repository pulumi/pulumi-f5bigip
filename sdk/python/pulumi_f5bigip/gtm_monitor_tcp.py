...
__all__ = ['GtmMonitorTcpArgs', 'GtmMonitorTcp']
...
class GtmMonitorTcpArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Name of the GTM TCP monitor
...
@pulumi.type_token("f5bigip:index/gtmMonitorTcp:GtmMonitorTcp")
class GtmMonitorTcp(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param GtmMonitorTcpArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GtmMonitorTcpArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = GtmMonitorTcpArgs.__new__(GtmMonitorTcpArgs)
        ...
        super(GtmMonitorTcp, __self__).__init__(
            'f5bigip:index/gtmMonitorTcp:GtmMonitorTcp',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__ = _GtmMonitorTcpState.__new__(_GtmMonitorTcpState)
        ...
        __props__.__dict__["timeout"] = timeout
        __props__.__dict__["transparent"] = transparent
        return GtmMonitorTcp(resource_name, opts=opts, __props__=__props__)
