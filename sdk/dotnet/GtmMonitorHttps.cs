...
namespace Pulumi.F5BigIP
{
    ...
    /// {
    ///     var example = new F5BigIP.GtmMonitorHttps("example", new()
    ///     {
    ...
    /// return await Deployment.RunAsync(() =&gt; 
    /// {
    ///     var withCert = new F5BigIP.GtmMonitorHttps("with_cert", new()
    ///     {
    ///         Name = "/Common/my_https_monitor",
    ...
    /// ```
    /// </summary>
    [F5BigIPResourceType("f5bigip:index/gtmMonitorHttps:GtmMonitorHttps")]
    public partial class GtmMonitorHttps : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("cipherlist")]
        public Output<string?> Cipherlist { get; private set; } = null!;
        ...
        public GtmMonitorHttps(string name, GtmMonitorHttpsArgs args, CustomResourceOptions? options = null)
            : base("f5bigip:index/gtmMonitorHttps:GtmMonitorHttps", name, args ?? new GtmMonitorHttpsArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GtmMonitorHttps(string name, Input<string> id, GtmMonitorHttpsState? state = null, CustomResourceOptions? options = null)
            : base("f5bigip:index/gtmMonitorHttps:GtmMonitorHttps", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GtmMonitorHttps Get(string name, Input<string> id, GtmMonitorHttpsState? state = null, CustomResourceOptions? options = null)
        {
            return new GtmMonitorHttps(name, id, state, options);
        }
    }

    public sealed class GtmMonitorHttpsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Specifies a fully-qualified path for a client certificate that the monitor sends to the target SSL server
        /// </summary>
        ...
        /// </summary>
        [Input("cipherlist")]
        public Input<string>? Cipherlist { get; set; }
        ...
        public GtmMonitorHttpsArgs()
        {
        }
        public static new GtmMonitorHttpsArgs Empty => new GtmMonitorHttpsArgs();
    }

    public sealed class GtmMonitorHttpsState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Specifies a fully-qualified path for a client certificate that the monitor sends to the target SSL server
        /// </summary>
        ...
        public GtmMonitorHttpsState()
        {
        }
        public static new GtmMonitorHttpsState Empty => new GtmMonitorHttpsState();
    }
}
