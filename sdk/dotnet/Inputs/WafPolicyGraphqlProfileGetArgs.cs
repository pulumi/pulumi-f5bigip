...
namespace Pulumi.F5BigIP.Inputs
{
    ...
    public sealed class WafPolicyGraphqlProfileGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.WafPolicyGraphqlProfileDefenseAttributeGetArgs>? _defenseAttributes;

        /// <summary>
        /// `defense_attributes` block settings for GraphQl policy.See defense attributes below for more details.
        /// </summary>
        public InputList<Inputs.WafPolicyGraphqlProfileDefenseAttributeGetArgs> DefenseAttributes
        {
            get => _defenseAttributes ?? (_defenseAttributes = new InputList<Inputs.WafPolicyGraphqlProfileDefenseAttributeGetArgs>());
        ...
        public WafPolicyGraphqlProfileGetArgs()
        {
        }
        public static new WafPolicyGraphqlProfileGetArgs Empty => new WafPolicyGraphqlProfileGetArgs();
    }
}
