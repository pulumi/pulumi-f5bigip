...
namespace Pulumi.F5BigIP
{
    ...
    /// ```
    /// </summary>
    [F5BigIPResourceType("f5bigip:index/gtmMonitorTcp:GtmMonitorTcp")]
    public partial class GtmMonitorTcp : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public GtmMonitorTcp(string name, GtmMonitorTcpArgs args, CustomResourceOptions? options = null)
            : base("f5bigip:index/gtmMonitorTcp:GtmMonitorTcp", name, args ?? new GtmMonitorTcpArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GtmMonitorTcp(string name, Input<string> id, GtmMonitorTcpState? state = null, CustomResourceOptions? options = null)
            : base("f5bigip:index/gtmMonitorTcp:GtmMonitorTcp", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static GtmMonitorTcp Get(string name, Input<string> id, GtmMonitorTcpState? state = null, CustomResourceOptions? options = null)
        {
            return new GtmMonitorTcp(name, id, state, options);
        }
    }

    public sealed class GtmMonitorTcpArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Inherit properties from this monitor
        /// </summary>
        ...
        public GtmMonitorTcpArgs()
        {
        }
        public static new GtmMonitorTcpArgs Empty => new GtmMonitorTcpArgs();
    }

    public sealed class GtmMonitorTcpState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Inherit properties from this monitor
        /// </summary>
        ...
        public GtmMonitorTcpState()
        {
        }
        public static new GtmMonitorTcpState Empty => new GtmMonitorTcpState();
    }
}
