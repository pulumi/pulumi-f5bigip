...
export class PersistenceProfileSrcAddr extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: PersistenceProfileSrcAddrArgs | PersistenceProfileSrcAddrState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts && opts.id) {
            const state: PersistenceProfileSrcAddrState = argsOrState as PersistenceProfileSrcAddrState | undefined;
        ...
        super("f5bigip:ltm/persistenceProfileSrcAddr:PersistenceProfileSrcAddr", name, inputs, opts);
    }
}
