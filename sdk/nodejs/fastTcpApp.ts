...
export interface FastTcpAppState {
     ...
     * Json payload for FAST TCP application.
     */
    fastTcpJson?: pulumi.Input<string | undefined>;
    /**
     * A `load balancing method` is an algorithm that the BIG-IP system uses to select a pool member for processing a request. F5 recommends the Least Connections load balancing method
     */
     ...
     * See Pool Monitor below for more details.
     */
    monitor?: pulumi.Input<inputs.FastTcpAppMonitor | undefined>;
    /**
     * Name of an existing BIG-IP persistence profile to be used.
     */
     ...
     * See Pool Members below for more details.
     */
    poolMembers?: pulumi.Input<pulumi.Input<inputs.FastTcpAppPoolMember>[] | undefined>;
    /**
     * Slow ramp temporarily throttles the number of connections to a new pool member. The recommended value is 300 seconds
     */
     ...
     * See virtual server below for more details.
     */
    virtualServer?: pulumi.Input<inputs.FastTcpAppVirtualServer | undefined>;
}
