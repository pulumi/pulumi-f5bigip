...
export class Partition extends pulumi.CustomResource {
     ...
     */
    declare public readonly routeDomainId: pulumi.Output<number | undefined>;
    ...
    constructor(name: string, argsOrState?: PartitionArgs | PartitionState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["routeDomainId"] = state?.routeDomainId;
        } else {
            ...
            resourceInputs["routeDomainId"] = args?.routeDomainId;
        }
