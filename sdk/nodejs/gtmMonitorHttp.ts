 ...
 * ```
 */
export class GtmMonitorHttp extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GtmMonitorHttpState, opts?: pulumi.CustomResourceOptions): GtmMonitorHttp {
        return new GtmMonitorHttp(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'f5bigip:index/gtmMonitorHttp:GtmMonitorHttp';

    /**
     * Returns true if the given object is an instance of GtmMonitorHttp.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GtmMonitorHttp {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GtmMonitorHttp.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState?: GtmMonitorHttpArgs | GtmMonitorHttpState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as GtmMonitorHttpState | undefined;
            ...
            const args = argsOrState as GtmMonitorHttpArgs | undefined;
        ...
        super(GtmMonitorHttp.__pulumiType, name, resourceInputs, opts);
    }
}
