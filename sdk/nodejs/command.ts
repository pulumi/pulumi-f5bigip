 ...
 * 
 * //create ltm node
 * const testCommand = new f5bigip.Command("test-command", {
 *     commands: ["delete ltm node 10.10.10.70"],
 *     when: "destroy",
 * });
 * ```
 *
 * > This content is derived from https://github.com/terraform-providers/terraform-provider-bigip/blob/master/website/docs/r/bigip_command.html.markdown.
 */
