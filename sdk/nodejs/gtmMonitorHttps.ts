 ...
 * ```
 */
export class GtmMonitorHttps extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GtmMonitorHttpsState, opts?: pulumi.CustomResourceOptions): GtmMonitorHttps {
        return new GtmMonitorHttps(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'f5bigip:index/gtmMonitorHttps:GtmMonitorHttps';

    /**
     * Returns true if the given object is an instance of GtmMonitorHttps.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GtmMonitorHttps {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GtmMonitorHttps.__pulumiType;
    }
     ...
     */
    declare public readonly cipherlist: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: GtmMonitorHttpsArgs | GtmMonitorHttpsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as GtmMonitorHttpsState | undefined;
            resourceInputs["cert"] = state?.cert;
            resourceInputs["cipherlist"] = state?.cipherlist;
            ...
            const args = argsOrState as GtmMonitorHttpsArgs | undefined;
            if (args?.name === undefined && !opts.urn) {
                throw new Error("Missing required property 'name'");
            }
            resourceInputs["cert"] = args?.cert;
            resourceInputs["cipherlist"] = args?.cipherlist;
        ...
        super(GtmMonitorHttps.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface GtmMonitorHttpsState {
     ...
     * Specifies the list of ciphers for this monitor
     */
    cipherlist?: pulumi.Input<string>;
    /**
     * Specifies the SSL version compatibility
     */
