...
public final class CommonLicenseManageBigIqState extends com.pulumi.resources.ResourceArgs {

    public static final CommonLicenseManageBigIqState Empty = new CommonLicenseManageBigIqState();
     ...
     * 
     */
    @Import(name="licensePoolname")
    private @Nullable Output<String> licensePoolname;

    /**
     * @return A name given to the license pool. type `string`
     * 
     */
    public Optional<Output<String>> licensePoolname() {
        return Optional.ofNullable(this.licensePoolname);
    }
    ...
    private CommonLicenseManageBigIqState() {}

    private CommonLicenseManageBigIqState(CommonLicenseManageBigIqState $) {
    ...
    public static Builder builder(CommonLicenseManageBigIqState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CommonLicenseManageBigIqState();
        }

        public Builder(CommonLicenseManageBigIqState defaults) {
            $ = new CommonLicenseManageBigIqState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder licensePoolname(@Nullable Output<String> licensePoolname) {
        ...
        public CommonLicenseManageBigIqState build() {
            return $;
        }
    }
