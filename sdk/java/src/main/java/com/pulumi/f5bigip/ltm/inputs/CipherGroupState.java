...
public final class CipherGroupState extends com.pulumi.resources.ResourceArgs {

    public static final CipherGroupState Empty = new CipherGroupState();
    ...
    private CipherGroupState() {}

    private CipherGroupState(CipherGroupState $) {
        this.allows = $.allows;
    ...
    public static Builder builder(CipherGroupState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CipherGroupState();
        }

        public Builder(CipherGroupState defaults) {
            $ = new CipherGroupState(Objects.requireNonNull(defaults));
        }
