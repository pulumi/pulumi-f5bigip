...
public final class ProfileHttp2State extends com.pulumi.resources.ResourceArgs {

    public static final ProfileHttp2State Empty = new ProfileHttp2State();
    ...
    private ProfileHttp2State() {}

    private ProfileHttp2State(ProfileHttp2State $) {
    ...
    public static Builder builder(ProfileHttp2State defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProfileHttp2State();
        }

        public Builder(ProfileHttp2State defaults) {
            $ = new ProfileHttp2State(Objects.requireNonNull(defaults));
        }
        ...
        public ProfileHttp2State build() {
            return $;
        }
    }
