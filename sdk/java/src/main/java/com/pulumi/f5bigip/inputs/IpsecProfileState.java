...
public final class IpsecProfileState extends com.pulumi.resources.ResourceArgs {

    public static final IpsecProfileState Empty = new IpsecProfileState();
    ...
    private IpsecProfileState() {}

    private IpsecProfileState(IpsecProfileState $) {
    ...
    public static Builder builder(IpsecProfileState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IpsecProfileState();
        }

        public Builder(IpsecProfileState defaults) {
            $ = new IpsecProfileState(Objects.requireNonNull(defaults));
        }
        ...
        public IpsecProfileState build() {
            return $;
        }
    }
