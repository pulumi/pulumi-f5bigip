...
public final class ProfileWebAccelerationArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProfileWebAccelerationArgs Empty = new ProfileWebAccelerationArgs();
    ...
    private ProfileWebAccelerationArgs() {}

    private ProfileWebAccelerationArgs(ProfileWebAccelerationArgs $) {
    ...
    public static Builder builder(ProfileWebAccelerationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProfileWebAccelerationArgs();
        }

        public Builder(ProfileWebAccelerationArgs defaults) {
            $ = new ProfileWebAccelerationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ProfileWebAccelerationArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ProfileWebAccelerationArgs", "name");
            }
            return $;
        }
    }
