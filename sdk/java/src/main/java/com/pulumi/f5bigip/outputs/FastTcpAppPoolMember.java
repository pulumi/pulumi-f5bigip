...
@CustomType
public final class FastTcpAppPoolMember {
    /**
    ...
    public static Builder builder(FastTcpAppPoolMember defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean shareNodes;
        public Builder() {}
        public Builder(FastTcpAppPoolMember defaults) {
        ...
        public FastTcpAppPoolMember build() {
            final var _resultValue = new FastTcpAppPoolMember();
