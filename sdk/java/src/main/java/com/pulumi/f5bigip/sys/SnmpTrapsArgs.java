...
public final class SnmpTrapsArgs extends com.pulumi.resources.ResourceArgs {

    public static final SnmpTrapsArgs Empty = new SnmpTrapsArgs();
    ...
    private SnmpTrapsArgs() {}

    private SnmpTrapsArgs(SnmpTrapsArgs $) {
    ...
    public static Builder builder(SnmpTrapsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SnmpTrapsArgs defaults) {
            $ = new SnmpTrapsArgs(Objects.requireNonNull(defaults));
        }
