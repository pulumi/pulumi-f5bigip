...
public final class ProfileHttpArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProfileHttpArgs Empty = new ProfileHttpArgs();
    ...
    private ProfileHttpArgs() {}

    private ProfileHttpArgs(ProfileHttpArgs $) {
    ...
    public static Builder builder(ProfileHttpArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ProfileHttpArgs defaults) {
            $ = new ProfileHttpArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ProfileHttpArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ProfileHttpArgs", "name");
            }
            return $;
        }
    }
