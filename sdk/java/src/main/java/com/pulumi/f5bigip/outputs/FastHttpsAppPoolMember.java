...
@CustomType
public final class FastHttpsAppPoolMember {
    /**
    ...
    private FastHttpsAppPoolMember() {}
    /**
     * @return List of server address to be used for FAST-Generated Pool.
     * 
     */
    ...
    public static Builder builder(FastHttpsAppPoolMember defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean shareNodes;
        public Builder() {}
        public Builder(FastHttpsAppPoolMember defaults) {
        ...
        public Builder addresses(List<String> addresses) {
            if (addresses == null) {
              throw new MissingRequiredPropertyException("FastHttpsAppPoolMember", "addresses");
            }
