...
public final class NetIkePeerState extends com.pulumi.resources.ResourceArgs {

    public static final NetIkePeerState Empty = new NetIkePeerState();
    ...
    private NetIkePeerState() {}

    private NetIkePeerState(NetIkePeerState $) {
    ...
    public static Builder builder(NetIkePeerState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(NetIkePeerState defaults) {
            $ = new NetIkePeerState(Objects.requireNonNull(defaults));
        }
