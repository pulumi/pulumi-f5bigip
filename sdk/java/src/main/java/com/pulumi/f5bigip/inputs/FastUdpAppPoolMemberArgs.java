...
public final class FastUdpAppPoolMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final FastUdpAppPoolMemberArgs Empty = new FastUdpAppPoolMemberArgs();
    ...
    private FastUdpAppPoolMemberArgs() {}

    private FastUdpAppPoolMemberArgs(FastUdpAppPoolMemberArgs $) {
    ...
    public static Builder builder(FastUdpAppPoolMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FastUdpAppPoolMemberArgs();
        }

        public Builder(FastUdpAppPoolMemberArgs defaults) {
            $ = new FastUdpAppPoolMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FastUdpAppPoolMemberArgs build() {
            if ($.addresses == null) {
                throw new MissingRequiredPropertyException("FastUdpAppPoolMemberArgs", "addresses");
            }
            return $;
        }
    }
