...
public final class FastHttpsAppCreateTlsServerProfile {
    ...
    private FastHttpsAppCreateTlsServerProfile() {}
    /**
     * @return Name of existing BIG-IP SSL certificate to be used for FAST-Generated TLS Server Profile.
     * 
     */
    ...
    public static Builder builder(FastHttpsAppCreateTlsServerProfile defaults) {
    ...
    public static final class Builder {
        ...
        private String tlsKeyName;
        public Builder() {}
        public Builder(FastHttpsAppCreateTlsServerProfile defaults) {
        ...
        public FastHttpsAppCreateTlsServerProfile build() {
            final var o = new FastHttpsAppCreateTlsServerProfile();
