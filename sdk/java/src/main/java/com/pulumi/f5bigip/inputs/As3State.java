...
public final class As3State extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(As3State defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(As3State defaults) {
            $ = new As3State(Objects.requireNonNull(defaults));
        }
