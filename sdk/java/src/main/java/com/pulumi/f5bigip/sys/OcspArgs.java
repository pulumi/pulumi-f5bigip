...
public final class OcspArgs extends com.pulumi.resources.ResourceArgs {

    public static final OcspArgs Empty = new OcspArgs();
    ...
    public static Builder builder(OcspArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(OcspArgs defaults) {
            $ = new OcspArgs(Objects.requireNonNull(defaults));
        }
        ...
        public OcspArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("OcspArgs", "name");
            }
            return $;
        }
    }
