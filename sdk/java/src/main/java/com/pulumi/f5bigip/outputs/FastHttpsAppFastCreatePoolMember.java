...
@CustomType
public final class FastHttpsAppFastCreatePoolMember {
    /**
    ...
    private FastHttpsAppFastCreatePoolMember() {}
    /**
     * @return List of server address to be used for FAST-Generated Pool.
     * 
     */
    ...
    public static Builder builder(FastHttpsAppFastCreatePoolMember defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean shareNodes;
        public Builder() {}
        public Builder(FastHttpsAppFastCreatePoolMember defaults) {
        ...
        public FastHttpsAppFastCreatePoolMember build() {
            final var o = new FastHttpsAppFastCreatePoolMember();
