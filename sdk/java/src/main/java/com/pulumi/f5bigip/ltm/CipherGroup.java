...
public class CipherGroup extends com.pulumi.resources.CustomResource {
     ...
     */
    public CipherGroup(java.lang.String name) {
     ...
     */
    public CipherGroup(java.lang.String name, CipherGroupArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public CipherGroup(java.lang.String name, CipherGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("f5bigip:ltm/cipherGroup:CipherGroup", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private CipherGroup(java.lang.String name, Output<java.lang.String> id, @Nullable CipherGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("f5bigip:ltm/cipherGroup:CipherGroup", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static CipherGroup get(java.lang.String name, Output<java.lang.String> id, @Nullable CipherGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
