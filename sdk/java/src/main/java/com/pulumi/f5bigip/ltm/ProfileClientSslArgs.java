...
public final class ProfileClientSslArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProfileClientSslArgs Empty = new ProfileClientSslArgs();
    ...
    public static Builder builder(ProfileClientSslArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProfileClientSslArgs();
        }

        public Builder(ProfileClientSslArgs defaults) {
            $ = new ProfileClientSslArgs(Objects.requireNonNull(defaults));
        }
