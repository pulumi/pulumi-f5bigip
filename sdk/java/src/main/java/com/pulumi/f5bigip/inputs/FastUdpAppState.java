...
public final class FastUdpAppState extends com.pulumi.resources.ResourceArgs {

    public static final FastUdpAppState Empty = new FastUdpAppState();
     ...
     * 
     */
    @Import(name="fastUdpJson")
    private @Nullable Output<String> fastUdpJson;

    /**
     * @return Json payload for FAST UDP application.
     * 
     */
    public Optional<Output<String>> fastUdpJson() {
        return Optional.ofNullable(this.fastUdpJson);
    }
    ...
    private FastUdpAppState() {}

    private FastUdpAppState(FastUdpAppState $) {
    ...
    public static Builder builder(FastUdpAppState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FastUdpAppState defaults) {
            $ = new FastUdpAppState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param fastUdpJson Json payload for FAST UDP application.
         * 
         * @return builder
         * 
         */
        public Builder fastUdpJson(@Nullable Output<String> fastUdpJson) {
         ...
         * 
         */
        public Builder fastUdpJson(String fastUdpJson) {
            return fastUdpJson(Output.of(fastUdpJson));
        }
