...
@CustomType
public final class FastUdpAppPoolMember {
    /**
    ...
    public static Builder builder(FastUdpAppPoolMember defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean shareNodes;
        public Builder() {}
        public Builder(FastUdpAppPoolMember defaults) {
        ...
        public Builder addresses(List<String> addresses) {
            if (addresses == null) {
              throw new MissingRequiredPropertyException("FastUdpAppPoolMember", "addresses");
            }
