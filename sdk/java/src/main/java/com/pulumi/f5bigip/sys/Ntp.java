...
public class Ntp extends com.pulumi.resources.CustomResource {
     ...
     */
    public Ntp(String name, NtpArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("f5bigip:sys/ntp:Ntp", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Ntp(String name, Output<String> id, @Nullable NtpState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("f5bigip:sys/ntp:Ntp", name, state, makeResourceOptions(options, id));
    }
