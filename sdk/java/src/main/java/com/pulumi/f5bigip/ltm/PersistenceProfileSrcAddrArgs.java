...
public final class PersistenceProfileSrcAddrArgs extends com.pulumi.resources.ResourceArgs {

    public static final PersistenceProfileSrcAddrArgs Empty = new PersistenceProfileSrcAddrArgs();
    ...
    private PersistenceProfileSrcAddrArgs() {}

    private PersistenceProfileSrcAddrArgs(PersistenceProfileSrcAddrArgs $) {
    ...
    public static Builder builder(PersistenceProfileSrcAddrArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PersistenceProfileSrcAddrArgs();
        }

        public Builder(PersistenceProfileSrcAddrArgs defaults) {
            $ = new PersistenceProfileSrcAddrArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PersistenceProfileSrcAddrArgs build() {
            if ($.defaultsFrom == null) {
                throw new MissingRequiredPropertyException("PersistenceProfileSrcAddrArgs", "defaultsFrom");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PersistenceProfileSrcAddrArgs", "name");
            }
            return $;
        }
    }
