...
@CustomType
public final class FastHttpAppServiceDiscovery {
    /**
    ...
    public static Builder builder(FastHttpAppServiceDiscovery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sdUndetectableAction;
        public Builder() {}
        public Builder(FastHttpAppServiceDiscovery defaults) {
        ...
        public FastHttpAppServiceDiscovery build() {
            final var o = new FastHttpAppServiceDiscovery();
