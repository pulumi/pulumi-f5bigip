...
public class Guest extends com.pulumi.resources.CustomResource {
     ...
     */
    public Guest(java.lang.String name, GuestArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Guest(java.lang.String name, GuestArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("f5bigip:vcmp/guest:Guest", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private Guest(java.lang.String name, Output<java.lang.String> id, @Nullable GuestState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("f5bigip:vcmp/guest:Guest", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static Guest get(java.lang.String name, Output<java.lang.String> id, @Nullable GuestState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
