...
public final class ProfileRewriteArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProfileRewriteArgs Empty = new ProfileRewriteArgs();
     ...
     * 
     */
    @Import(name="rewriteMode", required=true)
    ...
    private ProfileRewriteArgs() {}

    private ProfileRewriteArgs(ProfileRewriteArgs $) {
    ...
    public static Builder builder(ProfileRewriteArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProfileRewriteArgs();
        }

        public Builder(ProfileRewriteArgs defaults) {
            $ = new ProfileRewriteArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder rewriteMode(Output<String> rewriteMode) {
        ...
        public ProfileRewriteArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ProfileRewriteArgs", "name");
            }
            if ($.rewriteMode == null) {
                throw new MissingRequiredPropertyException("ProfileRewriteArgs", "rewriteMode");
            }
            return $;
        }
    }
