...
public class NetIkePeer extends com.pulumi.resources.CustomResource {
     ...
     */
    public NetIkePeer(java.lang.String name) {
     ...
     */
    public NetIkePeer(java.lang.String name, NetIkePeerArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public NetIkePeer(java.lang.String name, NetIkePeerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("f5bigip:index/netIkePeer:NetIkePeer", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private NetIkePeer(java.lang.String name, Output<java.lang.String> id, @Nullable NetIkePeerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("f5bigip:index/netIkePeer:NetIkePeer", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static NetIkePeer get(java.lang.String name, Output<java.lang.String> id, @Nullable NetIkePeerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
