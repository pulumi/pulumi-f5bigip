...
public class PersistenceProfileSsl extends com.pulumi.resources.CustomResource {
    ...
    public PersistenceProfileSsl(String name, PersistenceProfileSslArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("f5bigip:ltm/persistenceProfileSsl:PersistenceProfileSsl", name, args == null ? PersistenceProfileSslArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
