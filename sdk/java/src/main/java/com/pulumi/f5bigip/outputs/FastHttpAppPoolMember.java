...
@CustomType
public final class FastHttpAppPoolMember {
    /**
    ...
    public static Builder builder(FastHttpAppPoolMember defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean shareNodes;
        public Builder() {}
        public Builder(FastHttpAppPoolMember defaults) {
        ...
        public Builder addresses(List<String> addresses) {
            if (addresses == null) {
              throw new MissingRequiredPropertyException("FastHttpAppPoolMember", "addresses");
            }
        ...
        public FastHttpAppPoolMember build() {
            final var _resultValue = new FastHttpAppPoolMember();
