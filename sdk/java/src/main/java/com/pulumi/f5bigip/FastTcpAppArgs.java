...
public final class FastTcpAppArgs extends com.pulumi.resources.ResourceArgs {

    public static final FastTcpAppArgs Empty = new FastTcpAppArgs();
    ...
    public static Builder builder(FastTcpAppArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FastTcpAppArgs defaults) {
            $ = new FastTcpAppArgs(Objects.requireNonNull(defaults));
        }
