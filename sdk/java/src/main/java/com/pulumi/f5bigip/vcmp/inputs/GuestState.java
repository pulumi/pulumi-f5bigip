...
package com.pulumi.f5bigip.vcmp.inputs;
...
public final class GuestState extends com.pulumi.resources.ResourceArgs {

    public static final GuestState Empty = new GuestState();
     ...
     * 
     */
    @Import(name="virtualDisk")
    private @Nullable Output<String> virtualDisk;

    /**
     * @return Virtual disk associated with vCMP guest.
     * 
     */
    public Optional<Output<String>> virtualDisk() {
        return Optional.ofNullable(this.virtualDisk);
    }
    ...
    public static Builder builder(GuestState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GuestState defaults) {
            $ = new GuestState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param fullPath Resource name including prepended partition path.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param virtualDisk Virtual disk associated with vCMP guest.
         * 
         * @return builder
         * 
         */
        public Builder virtualDisk(@Nullable Output<String> virtualDisk) {
         ...
         * 
         */
        public Builder virtualDisk(String virtualDisk) {
            return virtualDisk(Output.of(virtualDisk));
        }
