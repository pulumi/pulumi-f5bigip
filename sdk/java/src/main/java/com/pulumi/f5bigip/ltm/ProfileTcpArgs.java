...
public final class ProfileTcpArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProfileTcpArgs Empty = new ProfileTcpArgs();
    ...
    public static Builder builder(ProfileTcpArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ProfileTcpArgs defaults) {
            $ = new ProfileTcpArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ProfileTcpArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ProfileTcpArgs", "name");
            }
            return $;
        }
    }
