...
public final class FastHttpAppState extends com.pulumi.resources.ResourceArgs {

    public static final FastHttpAppState Empty = new FastHttpAppState();
     ...
     * 
     */
    @Import(name="fastHttpJson")
    private @Nullable Output<String> fastHttpJson;

    /**
     * @return Json payload for FAST HTTP application.
     * 
     */
    public Optional<Output<String>> fastHttpJson() {
        return Optional.ofNullable(this.fastHttpJson);
    }
    ...
    private FastHttpAppState() {}

    private FastHttpAppState(FastHttpAppState $) {
        ...
        this.fastHttpJson = $.fastHttpJson;
    ...
    public static Builder builder(FastHttpAppState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FastHttpAppState();
        }

        public Builder(FastHttpAppState defaults) {
            $ = new FastHttpAppState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param fastHttpJson Json payload for FAST HTTP application.
         * 
         * @return builder
         * 
         */
        public Builder fastHttpJson(@Nullable Output<String> fastHttpJson) {
         ...
         * 
         */
        public Builder fastHttpJson(String fastHttpJson) {
            return fastHttpJson(Output.of(fastHttpJson));
        }
