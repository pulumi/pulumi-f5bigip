...
public final class RequestLogProfileArgs extends com.pulumi.resources.ResourceArgs {

    public static final RequestLogProfileArgs Empty = new RequestLogProfileArgs();
    ...
    private RequestLogProfileArgs() {}

    private RequestLogProfileArgs(RequestLogProfileArgs $) {
    ...
    public static Builder builder(RequestLogProfileArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RequestLogProfileArgs();
        }

        public Builder(RequestLogProfileArgs defaults) {
            $ = new RequestLogProfileArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RequestLogProfileArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("RequestLogProfileArgs", "name");
            }
            return $;
        }
    }
